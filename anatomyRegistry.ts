...
export const ANATOMY_REGISTRY_KNEE: AnatomyMeta[] = [
  ...
  },
  {
    ...
    region: "Thigh",
    type: "Muscle",
    description: "Four muscles (rectus femoris, vastus lateralis, vastus medialis, vastus intermedius) that extend the knee",
...
export const ANATOMY_REGISTRY_HEART: AnatomyMeta[] = [
  ...
  },
  {
    ...
    relatedConditions: ["CV__valvular_disease__mitral_stenosis", "CV__valvular_disease__mitral_regurgitation"],
  },
  {
    name: "Aortic Valve",
    system: "CV",
    ...
    relatedConditions: ["CV__valvular_disease__aortic_stenosis", "CV__valvular_disease__aortic_regurgitation"],
  },
];
...
export const ANATOMY_REGISTRY_PULM: AnatomyMeta[] = [
  {
    ...
    region: "Lungs",
    type: "Airway",
    description: "Wider, shorter, and more vertical than left; foreign bodies more likely to lodge here",
...
export const ANATOMY_REGISTRY_GI: AnatomyMeta[] = [
  {
    ...
    bloodSupply: "Inferior thyroid artery (upper), bronchial arteries (middle), left gastric artery (lower)",
