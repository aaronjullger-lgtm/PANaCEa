...
1. **[API Overview](api/API_OVERVIEW.md)** - Request/response contracts for validation-hardened routes (`/api/analytics/soap-note`, `/api/push/subscribe`, `/api/reviews/second-chance`) and other documented endpoints
...
- **[API Overview](api/API_OVERVIEW.md)** - Updated endpoint contracts for validation-hardened routes (`/api/analytics/soap-note`, `/api/push/subscribe`, `/api/reviews/second-chance`) plus admin and OSCE routes
