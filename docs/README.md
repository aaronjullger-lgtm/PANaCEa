...
- **[API Overview](api/API_OVERVIEW.md)** - Updated endpoint contracts for validation-hardened routes (`/api/analytics/soap-note`, `/api/feedback/submit`, `/api/push/subscribe`, `/api/reviews/second-chance`, `/api/srs/due`)
