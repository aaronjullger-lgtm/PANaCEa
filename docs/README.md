...
- **[API Overview](api/API_OVERVIEW.md)** - Current contracts for changed Cloudflare Functions routes, including agents, OSCE, study-plan, batch drill submission, and semantic-cache-backed AI endpoints.
