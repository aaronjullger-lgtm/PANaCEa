...
- **[API Overview](api/API_OVERVIEW.md)** - Agent runner and Agent Protocol endpoint contracts (`/api/agents/run`, `/api/agents/runs`, `/api/agents/threads`) plus admin and OSCE routes
