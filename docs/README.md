...
- **[API Overview](api/API_OVERVIEW.md)** - Updated question-serving and admin-preview generation contracts (`/api/questions/fetch`, `/api/questions/generate-deep`) plus Vertex AI shared routing
