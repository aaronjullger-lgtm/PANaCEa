...
- **[API Overview](api/API_OVERVIEW.md)** - Updated endpoint contracts for agents MCP, dashboard stats, drill submit-review, question attempt, library semantic search, and question embeddings
