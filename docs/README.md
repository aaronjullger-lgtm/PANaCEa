...
- **[API Overview](api/API_OVERVIEW.md)** - Endpoint contracts for validation-hardened routes (`/api/analytics/soap-note`, `/api/push/subscribe`, `/api/reviews/second-chance`) plus admin and OSCE routes
