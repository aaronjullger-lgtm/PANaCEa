...
- **[API Overview](api/API_OVERVIEW.md)** - Endpoint contracts for AI Gateway (`/api/ai/models`, `/api/ai/chat/stream`), staging/refinery pipeline, agents, admin, and OSCE routes
