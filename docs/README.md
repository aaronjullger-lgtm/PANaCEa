...
- **[API Overview](api/API_OVERVIEW.md)** - Updated endpoint contracts including `POST /api/agents/run` (student agent loop), admin (`/api/admin/check-access`, `/api/admin/stats`), and OSCE (`/api/osce/complete`, `/api/osce/stats`)
