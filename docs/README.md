...
- **[API Overview](api/API_OVERVIEW.md)** - Question generation endpoint contracts (`/api/questions/generate`, `/api/questions/generate-deep`) and opt-in clinical quality gate (`ENABLE_QUALITY_GATE`)
