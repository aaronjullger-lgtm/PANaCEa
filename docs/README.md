...
1. **[API Overview](api/API_OVERVIEW.md)** - Agent runner and infra-health endpoint contracts, tool catalog, shared response envelope
...
- **[API Overview](api/API_OVERVIEW.md)** - Agent endpoint contracts (`/api/agents/run`, `/api/agents/infra-health`) plus tool catalog and shared response envelope
