...
1. **[API Overview](api/API_OVERVIEW.md)** - Current request/response contracts for updated endpoints (including `/api/user/stats`)
...
- **[API Overview](api/API_OVERVIEW.md)** - Current changed API contracts (health, Gemini, content library, diagnostic puzzle, questions, user stats/goals/session, admin enrichment, OSCE grading)
