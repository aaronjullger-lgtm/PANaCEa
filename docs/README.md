...
- **[API Overview](api/API_OVERVIEW.md)** - Study mode endpoint contracts (`/api/study/session/generate`, `/api/questions/fetch`, `/api/drills/smart-review`, `/api/drills/submit-review`)
