...
- **[API Overview](api/API_OVERVIEW.md)** - Endpoint contracts for admin, OSCE, and agent orchestration (`/api/agents/health`, `/invoke`, `/run`, Agent Protocol `/runs` & `/threads`, MCP `/mcp`, admin tool-loop agents)
