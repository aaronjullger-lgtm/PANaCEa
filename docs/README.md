...
1. **[API Overview](api/API_OVERVIEW.md)** - Request/response contracts for validation-hardened endpoints (`/api/analytics/soap-note`, `/api/push/subscribe`, `/api/reviews/second-chance`)
...
- **[API Overview](api/API_OVERVIEW.md)** - Validation-hardened endpoint contracts (`/api/analytics/soap-note`, `/api/push/subscribe`, `/api/reviews/second-chance`)
