...
- **[API Overview](api/API_OVERVIEW.md)** - Current changed API contracts (health, Gemini, content library, diagnostic puzzle, questions, study-path optimizer, user goals/session, admin enrichment, OSCE grading)
