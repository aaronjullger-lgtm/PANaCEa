...
1. **[API Overview](api/API_OVERVIEW.md)** - Current request/response contracts for updated endpoints (AI Gateway: Socratic remediation, OSCE SPBench evaluate)
...
- **[API Overview](api/API_OVERVIEW.md)** - Updated AI Gateway endpoint contracts (`/api/ai/learning/socratic`, `/api/osce/evaluate`)
