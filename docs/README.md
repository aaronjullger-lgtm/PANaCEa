...
- **[API Overview](api/API_OVERVIEW.md)** - Updated endpoint contracts for validation-hardened routes (`/api/feedback/submit`, `/api/push/subscribe`, `/api/analytics/soap-note`, `/api/reviews/second-chance`, `/api/srs/due`)
