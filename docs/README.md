...
- **[API Overview](api/API_OVERVIEW.md)** - Validation-hardened endpoint contracts (`/api/analytics/soap-note`, `/api/feedback/submit`, `/api/push/subscribe`, `/api/reviews/second-chance`, `/api/srs/due`)
