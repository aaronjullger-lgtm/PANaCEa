...
| API validation hardening | `docs/audits/AUDIT_AUTH_SECURITY.md`; `docs/AUDIT_FOLLOW_UP.md` | `npm run audit:zod`; `functions/api/admin/**`; `functions/api/drills/submit-review.ts`; `functions/api/exam/*` | Partial |
