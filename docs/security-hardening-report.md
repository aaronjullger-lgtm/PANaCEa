...
- **Recently hardened contracts** (bounded lengths, finite numerics, `.strict()`): `POST/DELETE /api/push/subscribe`, `POST /api/analytics/soap-note`, `POST /api/reviews/second-chance` — see `docs/api/API_OVERVIEW.md`.
