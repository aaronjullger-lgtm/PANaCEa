...
- `GET /api/srs/due` — dashboard response contract pinned in tests (`items`, `totalDue`, `timestamp`; degraded path returns 200-shaped empty payload).
...
- **Contracts documented in** [`docs/api/API_OVERVIEW.md`](api/API_OVERVIEW.md).
