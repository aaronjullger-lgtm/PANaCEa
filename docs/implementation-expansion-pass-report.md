...
- `GET /api/srs/due` — dashboard response contract pinned in tests (stable `items`/`totalDue`/`timestamp`; degraded path never 500).
...
- **Contracts documented:** [`docs/api/API_OVERVIEW.md`](api/API_OVERVIEW.md).
