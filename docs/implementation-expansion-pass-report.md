...
- Contracts documented in `docs/api/API_OVERVIEW.md` (admin readiness, analytics, branches, drills, feedback, graph, library, medical APIs, push, custom sessions, second-chance, FSRS params, daily plan).
