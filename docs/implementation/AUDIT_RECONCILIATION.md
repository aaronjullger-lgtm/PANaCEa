...
- **Action this run:** closed the drill + session cluster via combined TASK-018 sprint; remainder stays deferred to TASK-019+ (admin cluster is largest remaining; should split into 2–3 sub-sprints — content-editors, review-queues/refinery, dashboards).
