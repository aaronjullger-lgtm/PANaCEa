...
export const PHYSIOLOGY_CONCEPTS_CV: PhysiologyConceptMeta[] = [
  ...
  },
  {
    name: "Afterload",
    category: "Cardiovascular",
    description: "Resistance the heart must overcome to eject blood; primarily determined by systemic vascular resistance",
  ...
  },
  {
    ...
    category: "Cardiovascular",
    description: "The heart's intrinsic ability to increase stroke volume in response to increased venous return",
  },
  {
    name: "Cardiac Output",
    aliases: ["CO"],
...
export const PHYSIOLOGY_CONCEPTS_CELLULAR: PhysiologyConceptMeta[] = [
  {
    ...
    description: "RNA molecule that carries genetic information from DNA to ribosomes for protein synthesis",
  },
  {
    name: "DNA",
    displayName: "DNA",
