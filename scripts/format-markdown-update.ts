/**
 * scripts/format-markdown-update.ts
 *
 * 📝 Markdown Syntax Standardization (Full Database Update)
 *
 * Applies the exact same Markdown formatting logic from format-markdown-dry-run.ts
 * to the entire MedicalContent table in Supabase.
 *
 ...
 *
 * Usage:
 *   npx ts-node scripts/format-markdown-update.ts
 *
 * Output:
...
/**
 * Formatting functions (identical to dry-run)
 */
...
async function main() {
  console.log('🚀 Starting full database Markdown formatting update...');
