...
async function main() {
  ...
  console.log(`  • Accent on background: ${currentAccentOnBg.toFixed(2)}:1 (${currentAccentOnBg >= 4.5 ? '✅' : '❌'} WCAG AA)`);
  console.log(`  • Button on background: ${currentButtonOnBg.toFixed(2)}:1 (${currentButtonOnBg >= 4.5 ? '✅' : '❌'} WCAG AA)`);
  console.log(`  • Text on button: ${currentTextOnButton.toFixed(2)}:1 (${currentTextOnButton >= 4.5 ? '✅' : '❌'} WCAG AA)`);
  console.log('');
  ...
  console.log(`  • Button on background: ${darkenedButtonOnBg.toFixed(2)}:1 (${darkenedButtonOnBg >= 4.5 ? '✅' : '❌'})`);
  console.log(`  • Text on button: ${textOnDarkenedButton.toFixed(2)}:1 (${textOnDarkenedButton >= 4.5 ? '✅' : '❌'})`);
  console.log(`  • Meets both: ${darkenedButtonOnBg >= 4.5 && textOnDarkenedButton >= 4.5 ? '✅ YES' : '❌ NO'}`);
  console.log('');
  ...
  console.log(`  • Border contrast with button: ${getContrastRatio(borderColor, currentAccentButton).toFixed(2)}:1`);
  console.log(`  • Border contrast with background: ${getContrastRatio(borderColor, bgPrimary).toFixed(2)}:1`);
  ...
  console.log(`  • Text on button: ${textOnButton.toFixed(2)}:1 (${textOnButton >= 4.5 ? '✅' : '❌'})`);
  ...
  console.log(`  • Button on background: ${optimalButtonOnBg.toFixed(2)}:1 (${optimalButtonOnBg >= 4.5 ? '✅' : '❌'})`);
  console.log(`  • Text on button: ${optimalTextOnButton.toFixed(2)}:1 (${optimalTextOnButton >= 4.5 ? '✅' : '❌'})`);
