...
async function main() {
  ...
  console.log(
    `  • Button on background: ${currentOnBg.toFixed(2)}:1 (${currentOnBg >= 4.5 ? '✅' : '❌'})`
  );
  console.log(
    `  • Text on button: ${currentTextOnBtn.toFixed(2)}:1 (${currentTextOnBtn >= 4.5 ? '✅' : '❌'})`
  );
  console.log('');
  ...
  topCandidates.forEach((candidate, index) => {
    ...
    console.log(
      `   Button on background: ${candidate.contrastOnBg.toFixed(2)}:1 (${candidate.contrastOnBg >= 4.5 ? '✅' : '❌'})`
    );
    console.log(
      `   Text on button: ${candidate.textContrast.toFixed(2)}:1 (${candidate.textContrast >= 4.5 ? '✅' : '❌'})`
    );
