      ...
      */
      ...
      await prisma.medicalContent.upsert({
        ...
        update: {
          ...
          subcategory,
          condition,
          overview: (actualContent as any).overview,
          etiology: (actualContent as any).etiology,
          pathophysiology: (actualContent as any).pathophysiology,
          epidemiology: (actualContent as any).epidemiology,
          symptoms: (actualContent as any).symptoms,
          physicalExam: (actualContent as any).physicalExam,
          diagnostics: (actualContent as any).diagnostics,
          treatment: (actualContent as any).treatment,
          prognosis: (actualContent as any).prognosis,
          riskFactors: (actualContent as any).riskFactors,
          complications: (actualContent as any).complications,
          updatedAt: new Date(),
        },
        create: {
          conditionId,
