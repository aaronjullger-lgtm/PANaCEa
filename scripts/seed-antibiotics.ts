...
const DRUG_MAP: Record<string, string> = ANTIBIOTICS.reduce((acc, drug) => {
...
const ORGANISM_GUIDELINES: OrganismGuideline[] = [
  {
    ...
    notes: 'Increasing resistance to macrolides in some regions. Fluoroquinolones reserved for penicillin-allergic patients.'
  },
  {
    ...
    notes: 'MSSA produces beta-lactamase, making it resistant to penicillin. Use anti-staphylococcal penicillins or cephalosporins.'
  },
  {
    organism: 'MRSA',
    class: 'Gram Positive',
    ...
    notes: 'Vancomycin is first-line for severe MRSA infections. Alternatives include Linezolid, Daptomycin, or Ceftaroline.'
  },
  {
    ...
    notes: 'Intrinsically resistant to cephalosporins. Ampicillin or Vancomycin are first-line. For serious infections, consider ampicillin + gentamicin.'
  },
  {
    organism: 'Escherichia coli',
    class: 'Gram Negative',
    description: 'Most common cause of urinary tract infections (UTI)',
    effectiveDrugs: ['Amoxicillin', 'Amoxicillin-Clavulanate', 'Ceftriaxone', 'Ciprofloxacin', 'Levofloxacin'],
    resistantDrugs: ['Penicillin', 'Azithromycin'],
    notes: 'First-line for uncomplicated UTI: Nitrofurantoin or TMP-SMX. Fluoroquinolone resistance increasing. ESBL strains require carbapenems.'
  },
  {
    ...
    resistantDrugs: ['Ceftriaxone', 'Amoxicillin', 'Amoxicillin-Clavulanate', 'Vancomycin', 'Azithromycin'],
    notes: 'Requires anti-pseudomonal antibiotics. Dual therapy often used for severe infections. Intrinsically resistant to many antibiotics.'
  },
  {
    ...
    notes: 'ESBL-producing strains require carbapenems. Often causes severe necrotizing pneumonia with "currant jelly" sputum.'
  },
  {
    ...
    notes: 'Many strains produce beta-lactamase. Use amoxicillin-clavulanate for beta-lactamase producers.'
  },
  {
    ...
    notes: 'No cell wall, so beta-lactams ineffective. Macrolides or tetracyclines are first-line. Associated with cold agglutinins.'
  },
  {
    ...
    resistantDrugs: ['Penicillin', 'Amoxicillin', 'Ceftriaxone', 'Vancomycin'],
    notes: 'Intracellular organism requiring antibiotics with good intracellular penetration. Fluoroquinolones or macrolides. Check urinary antigen.'
  },
  {
  ...
  },
  {
    ...
    notes: 'Fluconazole for most Candida species. Non-albicans species may require echinocandins (e.g., Caspofungin) or Amphotericin B.'
  },
  {
    ...
    notes: 'Increasing antibiotic resistance. Current CDC recommendation: Ceftriaxone 500mg IM (single dose). Often co-treat for Chlamydia with Azithromycin.'
  },
  {
    ...
    notes: 'Third-generation cephalosporin (Ceftriaxone or Cefotaxime) first-line. Close contacts need prophylaxis with Ciprofloxacin or Rifampin.'
  },
  {
    ...
    notes: 'Intrinsically resistant to cephalosporins. Ampicillin + Gentamicin is first-line. Add to empiric meningitis coverage in at-risk populations.'
  },
  {
    organism: 'Bacteroides fragilis',
    class: 'Anaerobic',
    description: 'Anaerobic infections (intra-abdominal, aspiration pneumonia)',
    effectiveDrugs: ['Metronidazole', 'Piperacillin-Tazobactam', 'Meropenem', 'Amoxicillin-Clavulanate'],
    resistantDrugs: ['Penicillin', 'Ceftriaxone', 'Azithromycin', 'Vancomycin'],
    notes: 'Most common anaerobic pathogen. Metronidazole is first-line for anaerobic coverage. Often part of polymicrobial infections.'
  },
  {
    ...
    notes: 'Oral Vancomycin is first-line for severe disease. Fidaxomicin for recurrent disease. IV Metronidazole if oral not possible.'
  },
  {
    ...
    resistantDrugs: ['Metronidazole'],
    notes: 'Penicillin is first-line (no resistance reported). Macrolides for penicillin-allergic patients. Clindamycin for toxin-mediated disease.'
  },
  {
    ...
    resistantDrugs: ['Metronidazole'],
    notes: 'Intrapartum prophylaxis with Penicillin G or Ampicillin to prevent neonatal sepsis. Vancomycin for penicillin-allergic patients.'
  },
  {
    ...
    effectiveDrugs: ['Penicillin', 'Amoxicillin', 'Ceftriaxone', 'Vancomycin'],
    resistantDrugs: ['Metronidazole'],
    notes: 'Penicillin or Ceftriaxone first-line. Often requires prolonged therapy for endocarditis. Prophylaxis before dental procedures in high-risk patients.'
  }
];
