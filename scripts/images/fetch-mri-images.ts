...
const MRI_CONDITIONS: MRICondition[] = [
  // =========== BRAIN MRI ===========
  {
    ...
    type: 'brain',
    searchTerms: ['acute stroke MRI DWI', 'diffusion restriction stroke', 'MRI brain infarct', 'DWI acute ischemic stroke'],
    correctDiagnosis: 'Acute Ischemic Stroke',
    distractors: ['Chronic infarct', 'Brain tumor', 'MS plaque'],
    visualFindings: 'Bright on DWI with corresponding dark ADC map (restricted diffusion), T2/FLAIR bright in subacute phase',
    clinicalContext: 'DWI most sensitive for acute stroke. Perfusion-diffusion mismatch = salvageable tissue.',
  ...
  },
  {
    ...
    type: 'brain',
    searchTerms: ['multiple sclerosis MRI', 'MS brain lesions MRI', 'demyelinating plaques MRI', 'periventricular lesions FLAIR'],
    correctDiagnosis: 'Multiple Sclerosis',
    distractors: ['Small vessel disease', 'Migraine', 'Neuromyelitis optica'],
    visualFindings: 'Periventricular ovoid T2/FLAIR hyperintense lesions (Dawson fingers), corpus callosum involvement, active lesions enhance',
    clinicalContext: 'McDonald criteria use MRI dissemination in time and space. Active lesions enhance with gadolinium.',
  ...
  },
  {
    ...
    type: 'brain',
    searchTerms: ['MRI intracerebral hemorrhage', 'gradient echo hemorrhage brain', 'SWI microbleeds MRI', 'brain MRI blood products'],
    correctDiagnosis: 'Intracerebral Hemorrhage',
    distractors: ['Tumor', 'Stroke', 'Calcification'],
    visualFindings: 'Signal varies with hemorrhage age; SWI/GRE sensitive to blood products, blooming artifact',
    clinicalContext: 'MRI signal depends on hemoglobin oxidation state. GRE/SWI most sensitive for blood.',
  ...
  },
  {
    ...
    visualFindings: 'FLAIR bright in sulci and cisterns, may see aneurysm on MRA, late subacute shows superficial siderosis',
    clinicalContext: 'CT more sensitive acutely; MRI FLAIR for subacute SAH. Evaluate for aneurysm.',
  ...
  },
  {
    ...
    visualFindings: 'Ring-enhancing lesion with restricted diffusion centrally (bright DWI, dark ADC), surrounding edema',
    clinicalContext: 'DWI differentiates from tumor (abscess restricts). Surgical drainage + antibiotics.',
  ...
  },
  {
    ...
    name: 'ADEM',
    type: 'brain',
    searchTerms: ['ADEM MRI', 'acute disseminated encephalomyelitis MRI', 'post-infectious demyelination MRI'],
    correctDiagnosis: 'Acute Disseminated Encephalomyelitis',
    distractors: ['Multiple sclerosis', 'Viral encephalitis', 'Leukodystrophy'],
    visualFindings: 'Multiple large demyelinating lesions in white matter, often bilateral, may involve deep gray matter',
    clinicalContext: 'Monophasic post-infectious/post-vaccination. Pediatric predominance. Steroids for treatment.',
    preferredSequence: 'T2 FLAIR',
    targetImageCount: 8
  },
  // =========== SPINE MRI ===========
  {
    ...
    type: 'spine',
    searchTerms: ['lumbar disc herniation MRI', 'herniated disc MRI', 'L5S1 disc protrusion', 'cervical disc herniation MRI'],
    correctDiagnosis: 'Lumbar Disc Herniation',
    distractors: ['Bulging disc', 'Spinal stenosis', 'Facet arthropathy'],
    visualFindings: 'Disc material extending beyond vertebral body margin, nerve root compression, may see annular tear',
    clinicalContext: 'Correlate with clinical symptoms. Most improve with conservative treatment. Surgery if severe or progressive.',
  ...
  },
  {
    ...
    type: 'spine',
    searchTerms: ['spinal stenosis MRI', 'lumbar stenosis MRI', 'narrowed spinal canal', 'cervical stenosis MRI'],
    correctDiagnosis: 'Spinal Stenosis',
    distractors: ['Disc herniation', 'Spondylolisthesis', 'Normal variant'],
    visualFindings: 'Narrowing of central canal or neural foramina, ligamentum flavum hypertrophy, facet hypertrophy',
    clinicalContext: 'Neurogenic claudication (pain with walking, relieved by sitting/leaning forward). Decompression if severe.',
  ...
  },
  {
    ...
    type: 'spine',
    searchTerms: ['cauda equina syndrome MRI', 'large central disc herniation', 'cauda equina compression MRI'],
    ...
    clinicalContext: 'Surgical emergency. Saddle anesthesia, urinary retention, bowel dysfunction. Urgent decompression.',
    preferredSequence: 'T2',
    targetImageCount: 10
  },
  {
    ...
    type: 'spine',
    searchTerms: ['vertebral compression fracture MRI', 'acute vertebral fracture MRI STIR', 'pathologic fracture spine'],
    correctDiagnosis: 'Vertebral Compression Fracture',
    distractors: ['Degenerative changes', 'Chronic fracture', 'Metastasis'],
    visualFindings: 'Vertebral body height loss, STIR bright (acute), T1 dark. May have retropulsion.',
    clinicalContext: 'STIR differentiates acute from chronic. Evaluate for pathologic cause. Kyphoplasty for pain.',
  ...
  },
  {
    ...
    type: 'spine',
    searchTerms: ['transverse myelitis MRI', 'spinal cord myelitis MRI', 'longitudinally extensive myelitis'],
    correctDiagnosis: 'Transverse Myelitis',
    distractors: ['MS', 'Cord compression', 'Spinal cord infarct'],
    visualFindings: 'T2 hyperintense spinal cord lesion, may span multiple segments, cord swelling acutely',
    clinicalContext: 'Consider MS, NMO, infection, autoimmune. CSF analysis helpful. Steroids for treatment.',
  ...
  // =========== MSK MRI ===========
  {
    ...
    name: 'ACL Tear',
    type: 'msk',
    searchTerms: ['ACL tear MRI', 'anterior cruciate ligament rupture MRI', 'knee ACL injury MRI', 'ACL complete tear'],
    correctDiagnosis: 'ACL Tear',
    distractors: ['PCL tear', 'Meniscus tear', 'MCL tear'],
    visualFindings: 'Discontinuity of ACL fibers, abnormal signal/edema, empty notch sign, bone bruise pattern',
    clinicalContext: 'Common sports injury. Positive Lachman test. ACL reconstruction for active patients.',
  ...
  },
  {
    ...
    name: 'Meniscus Tear',
    type: 'msk',
    searchTerms: ['meniscus tear MRI', 'meniscal tear knee', 'bucket handle meniscus', 'medial meniscus tear MRI'],
    correctDiagnosis: 'Meniscus Tear',
    distractors: ['Meniscal degeneration', 'ACL tear', 'Osteochondral defect'],
    visualFindings: 'Linear high signal extending to articular surface, displaced fragment in bucket handle',
    clinicalContext: 'Joint line tenderness, McMurray test. Arthroscopic repair/debridement if symptomatic.',
  ...
  },
  {
    ...
    type: 'msk',
    searchTerms: ['rotator cuff tear MRI', 'supraspinatus tear MRI', 'shoulder tendon tear MRI', 'full thickness RTC tear'],
    ...
    clinicalContext: 'Supraspinatus most common. Physical therapy first. Surgical repair for large/refractory tears.',
  ...
  },
  {
    ...
    clinicalContext: 'Dashboard injury mechanism. Less common than ACL. Often treated conservatively.',
    preferredSequence: 'T2 sagittal',
    targetImageCount: 10
  },
  {
  ...
  // =========== ABDOMINAL MRI ===========
  {
    ...
    visualFindings: 'Arterial phase enhancement with washout in portal/delayed phases, capsule, T2 mild hyperintense',
    clinicalContext: 'LI-RADS classification. In cirrhosis, imaging criteria diagnostic. AFP may be elevated.',
  ...
  },
  {
    ...
    type: 'abdomen',
    searchTerms: ['pancreatic adenocarcinoma MRI', 'pancreatic cancer MRI MRCP', 'pancreatic mass MRI'],
    correctDiagnosis: 'Pancreatic Adenocarcinoma',
    distractors: ['Pancreatitis', 'IPMN', 'Neuroendocrine tumor'],
    visualFindings: 'Hypointense mass on T1, ductal dilation (double duct sign), vascular involvement',
    clinicalContext: 'MRCP shows ductal anatomy. Assess resectability (vascular involvement). Poor prognosis.',
  ...
  // =========== CARDIAC MRI ===========
  {
    ...
    visualFindings: 'Asymmetric septal hypertrophy, SAM of mitral valve, late gadolinium enhancement at RV insertion',
    clinicalContext: 'Most common cause of sudden cardiac death in athletes. ICD for high-risk patients.',
  ...
  },
  {
    ...
    visualFindings: 'Subepicardial/mid-wall late gadolinium enhancement (non-coronary pattern), edema on T2',
    clinicalContext: 'Lake Louise criteria. Viral etiology common. Supportive care, avoid exercise.',
...
console.log(`📊 MRI conditions: ${MRI_CONDITIONS.length} conditions, ${TOTAL_TARGET_IMAGES} total target images`);
...
async function analyzeMRIImage(imageUrl: string, condition: MRICondition, retryCount = 0): Promise<MRIAnalysis | null> {
  if (!genAI) {
...
Respond ONLY with valid JSON.`;
    ...
    if (errorMsg.includes('429') || errorMsg.includes('RESOURCE_EXHAUSTED')) {
      if (retryCount < 3) {
        console.log(`  ⏳ Rate limited, waiting ${RATE_LIMIT.rateLimitBackoffMs/1000}s (retry ${retryCount + 1}/3)...`);
...
function fetchImageAsBuffer(url: string): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    protocol.get(url, options, (res: any) => {
...
async function saveMediaAsset(conditionId: string, publicUrl: string, originalUrl: string, condition: MRICondition, analysis: MRIAnalysis): Promise<void> {
  await prisma.mediaAsset.create({
    data: {
      ...
      tags: ['mri', condition.type, analysis.sequenceType?.toLowerCase() || '', condition.name.toLowerCase()].filter(Boolean),
      description: condition.clinicalContext,
      altText: `MRI showing ${condition.correctDiagnosis}`,
      confidence: analysis.confidence,
      qualityScore: analysis.qualityScore,
      aiMetadata: { mriType: analysis.mriType, sequenceType: analysis.sequenceType, detectedFinding: analysis.detectedFinding },
      status: 'approved',
...
async function processCondition(condition: MRICondition, dryRun: boolean): Promise<{ fetched: number; saved: number; errors: number }> {
    ...
    try {
      ...
      for (const result of results) {
        ...
        try {
          ...
          const publicUrl = await uploadToSupabase(buffer, `mri_${condition.id.replace(/[^a-z0-9]/gi, '_')}_${Date.now()}.jpg`);
          await saveMediaAsset(condition.id, publicUrl, result.originalUrl || result.url, condition, analysis);
...
async function main() {
  ...
  console.log(`📊 ${MRI_CONDITIONS.length} conditions, ${TOTAL_TARGET_IMAGES} total target images\n`);
...
`);
  ...
  console.log('\n' + '='.repeat(60));
  console.log(`📊 MRI SUMMARY: ${conditions.length} conditions | ${totals.fetched} fetched | ${totals.saved} saved | ${totals.errors} errors`);
