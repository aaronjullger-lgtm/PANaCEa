...
const ECG_CONDITIONS: ECGCondition[] = [
  // Arrhythmias - HIGH YIELD
  {
    ...
    searchTerms: ['atrial fibrillation ECG', 'afib rhythm strip ECG', 'irregular irregular ECG', 'atrial fibrillation 12 lead', 'AFib RVR ECG'],
    ...
    clinicalContext: 'Most common sustained arrhythmia. Risk of stroke, managed with rate/rhythm control and anticoagulation.',
    targetImageCount: 25 // Very high yield - most common arrhythmia
  },
  {
    conditionId: 'CV__ecg__atrial_flutter',
    name: 'Atrial Flutter',
    searchTerms: ['atrial flutter ECG', 'sawtooth flutter waves ECG', 'flutter pattern ECG', 'typical atrial flutter'],
    correctDiagnosis: 'Atrial Flutter',
    distractors: ['Atrial Fibrillation', 'SVT', 'Sinus Tachycardia'],
    visualFindings: 'Sawtooth flutter waves (F waves) at ~300 bpm, typically with 2:1 block giving ventricular rate ~150',
    clinicalContext: 'Macro-reentrant circuit in right atrium. Often converts to A-fib. Similar stroke risk.',
    targetImageCount: 15
  },
  {
    conditionId: 'CV__ecg__ventricular_tachycardia',
    name: 'Ventricular Tachycardia',
    searchTerms: ['ventricular tachycardia ECG', 'VT rhythm strip', 'wide complex tachycardia ECG', 'monomorphic VT', 'polymorphic VT'],
    ...
    clinicalContext: 'Life-threatening arrhythmia. May degenerate to V-fib. Treat with cardioversion/amiodarone.',
    targetImageCount: 20 // Critical to recognize
  },
  {
    conditionId: 'CV__ecg__ventricular_fibrillation',
    name: 'Ventricular Fibrillation',
    searchTerms: ['ventricular fibrillation ECG', 'VFib rhythm strip', 'chaotic ventricular rhythm ECG', 'coarse VFib', 'fine VFib'],
    ...
    clinicalContext: 'Cardiac arrest rhythm. Immediately defibrillate. CPR until defibrillator ready.',
    targetImageCount: 15 // Critical to recognize
  },
  {
    conditionId: 'CV__ecg__supraventricular_tachycardia',
    name: 'Supraventricular Tachycardia',
    searchTerms: ['SVT ECG', 'supraventricular tachycardia ECG', 'narrow complex tachycardia ECG', 'AVNRT ECG', 'AVRT ECG'],
    correctDiagnosis: 'Supraventricular Tachycardia (SVT)',
    distractors: ['Sinus Tachycardia', 'Atrial Flutter', 'Atrial Fibrillation'],
    visualFindings: 'Narrow QRS, regular, very rapid rate (150-250 bpm), absent or retrograde P waves',
  ...
  // STEMI patterns - EXTREMELY HIGH YIELD
  {
    ...
    name: 'Anterior STEMI',
    searchTerms: ['anterior STEMI ECG', 'anterior wall MI ECG', 'LAD occlusion ECG', 'anterior MI 12 lead', 'tombstone T waves'],
  ...
  },
  {
    ...
    name: 'Inferior STEMI',
    searchTerms: ['inferior STEMI ECG', 'inferior wall MI ECG', 'RCA occlusion ECG', 'inferior MI 12 lead'],
    ...
    clinicalContext: 'RCA or circumflex territory. Check for RV involvement (V4R). Avoid nitrates if RV MI.',
    targetImageCount: 25 // Most critical - must recognize immediately
  },
  {
    conditionId: 'CV__ecg__lateral_stemi',
    name: 'Lateral STEMI',
    searchTerms: ['lateral STEMI ECG', 'lateral wall MI ECG', 'circumflex occlusion ECG', 'high lateral STEMI'],
  ...
  // Heart blocks - HIGH YIELD
  {
    ...
    searchTerms: ['first degree heart block ECG', 'prolonged PR interval ECG', '1st degree AV block', 'first degree AV block'],
  ...
  },
  {
    ...
    searchTerms: ['Wenckebach ECG', 'Mobitz I ECG', 'second degree heart block type 1 ECG', 'Mobitz type I'],
    ...
    clinicalContext: 'AV nodal level. Usually benign, especially with inferior MI. May resolve spontaneously.',
    targetImageCount: 15
  },
  {
    conditionId: 'CV__conduction_disorders__second_degree_av_block_mobitz_ii',
    name: 'Second Degree AV Block Type II',
    searchTerms: ['Mobitz II ECG', 'Mobitz type 2 heart block ECG', 'second degree heart block type 2', 'Mobitz type II'],
    ...
    clinicalContext: 'Below AV node (His-Purkinje). High risk of progression to complete block. Pacemaker indicated.',
  ...
  },
  {
    ...
    searchTerms: ['complete heart block ECG', 'third degree AV block ECG', '3rd degree heart block', 'complete AV block'],
    correctDiagnosis: 'Third Degree (Complete) Heart Block',
    distractors: ['Second Degree Block', 'AV Dissociation', 'Junctional Rhythm'],
    visualFindings: 'Complete AV dissociation - P waves and QRS independent, regular atrial and ventricular rates',
    clinicalContext: 'No AV conduction. Escape rhythm (junctional or ventricular). Pacemaker required.',
    targetImageCount: 20 // Critical to recognize
  },
  // Bundle branch blocks - HIGH YIELD
  {
    ...
    clinicalContext: 'Often indicates structural heart disease. New LBBB with chest pain = STEMI equivalent.',
  ...
  },
  {
    ...
    searchTerms: ['RBBB ECG', 'right bundle branch block ECG', 'MaRRoW pattern ECG', 'RSR prime V1'],
  ...
  // Other ECG findings
  {
    ...
    searchTerms: ['hyperkalemia ECG', 'peaked T waves ECG', 'potassium toxicity ECG', 'tall T waves hyperkalemia', 'sine wave ECG'],
    ...
    clinicalContext: 'Medical emergency. Calcium gluconate for cardiac protection, then shift/eliminate potassium.',
    targetImageCount: 20 // Medical emergency - critical to recognize
  },
  {
    conditionId: 'CV__ecg__long_qt_syndrome',
    name: 'Long QT Syndrome',
    searchTerms: ['long QT syndrome ECG', 'prolonged QT interval ECG', 'QT prolongation', 'acquired long QT'],
    ...
    clinicalContext: 'Risk of Torsades de Pointes. Review medications (antipsychotics, antibiotics). Correct electrolytes.',
    targetImageCount: 15
  },
  {
    conditionId: 'CV__conduction_disorders__wolff_parkinson_white_syndrome',
    name: 'Wolff-Parkinson-White Syndrome',
    searchTerms: ['WPW syndrome ECG', 'delta wave ECG', 'Wolff Parkinson White ECG', 'pre-excitation ECG', 'short PR delta wave'],
    ...
    clinicalContext: 'Accessory pathway. Risk of rapid A-fib with 1:1 conduction. Avoid AV nodal blockers in A-fib.',
    targetImageCount: 15
  },
  {
    conditionId: 'CV__ecg__pericarditis_ecg',
    name: 'Pericarditis',
    searchTerms: ['pericarditis ECG', 'diffuse ST elevation ECG', 'PR depression ECG', 'Spodick sign ECG'],
    correctDiagnosis: 'Acute Pericarditis',
    distractors: ['STEMI', 'Early Repolarization', 'Myocarditis'],
    visualFindings: 'Diffuse ST elevation (concave up), PR depression, Spodick sign (downsloping TP segment)',
  ...
  },
  {
    ...
    searchTerms: ['pulmonary embolism ECG', 'S1Q3T3 ECG', 'PE ECG findings', 'right heart strain ECG'],
    correctDiagnosis: 'Pulmonary Embolism',
    distractors: ['Inferior STEMI', 'Right Heart Strain', 'RBBB'],
    visualFindings: 'S1Q3T3 (classic but rare), sinus tachycardia (most common), RBBB, right axis deviation',
    clinicalContext: 'ECG often nonspecific. Sinus tach most common. CT-PA gold standard for diagnosis.',
    targetImageCount: 15
  },
  {
    conditionId: 'CV__ecg__sinus_bradycardia',
    name: 'Sinus Bradycardia',
    searchTerms: ['sinus bradycardia ECG', 'slow heart rate ECG', 'bradycardia rhythm strip', 'symptomatic bradycardia'],
    correctDiagnosis: 'Sinus Bradycardia',
    distractors: ['Junctional Rhythm', 'Heart Block', 'Atrial Fibrillation with slow ventricular response'],
  ...
  },
  {
    ...
    searchTerms: ['torsades de pointes ECG', 'polymorphic VT ECG', 'twisting of the points ECG', 'long QT torsades'],
    correctDiagnosis: 'Torsades de Pointes',
    distractors: ['Ventricular Fibrillation', 'Monomorphic VT', 'Artifact'],
    visualFindings: 'Polymorphic VT with QRS complexes twisting around baseline, associated with long QT',
    clinicalContext: 'Often drug-induced (QT-prolonging drugs). Treat with IV magnesium, correct QT prolongation.',
    targetImageCount: 15
  },
  {
    conditionId: 'CV__ecg__premature_ventricular_complexes_pvcs',
    name: 'Premature Ventricular Complexes (PVCs)',
    searchTerms: ['PVC ECG', 'premature ventricular contraction ECG', 'ventricular ectopy ECG', 'bigeminy PVCs'],
    ...
    clinicalContext: 'Usually benign if uniform. Concerning if frequent (>10%), multifocal, or R-on-T.',
    targetImageCount: 12
  },
  {
    conditionId: 'CV__ecg__premature_atrial_complexes_pacs',
    name: 'Premature Atrial Complexes (PACs)',
    searchTerms: ['PAC ECG', 'premature atrial contraction ECG', 'atrial ectopy ECG', 'atrial premature beat'],
    correctDiagnosis: 'Premature Atrial Complexes (PACs)',
    distractors: ['PVCs', 'Sinus Arrhythmia', 'Atrial Fibrillation'],
    visualFindings: 'Early P wave (different morphology), narrow QRS, incomplete compensatory pause',
  ...
  },
  {
    ...
    searchTerms: ['Wellens syndrome ECG', 'Wellens sign ECG', 'LAD stenosis ECG', 'biphasic T waves V2 V3'],
    ...
    clinicalContext: 'High-grade LAD stenosis. Do NOT stress test - high risk of anterior MI. Needs cath.',
    targetImageCount: 12
  },
  {
  ...
  },
  {
    ...
    searchTerms: ['LVH ECG', 'left ventricular hypertrophy ECG', 'voltage criteria LVH', 'strain pattern ECG'],
  ...
  },
  {
    ...
    searchTerms: ['hypokalemia ECG', 'low potassium ECG', 'U wave ECG', 'flattened T waves hypokalemia'],
  ...
  },
  {
    ...
    searchTerms: ['digoxin effect ECG', 'digitalis effect ECG', 'Salvador Dali mustache ECG', 'scooped ST segment'],
    correctDiagnosis: 'Digoxin Effect',
    distractors: ['Ischemia', 'Hypokalemia', 'LVH strain'],
    visualFindings: 'Scooped ST depression (Salvador Dali mustache), shortened QT, may have T wave inversion',
  ...
  },
  {
    ...
    clinicalContext: 'Escape rhythm when SA node fails. Rate 40-60 bpm. May need pacing if symptomatic.',
    targetImageCount: 10
  },
  {
    conditionId: 'CV__ecg__early_repolarization',
    name: 'Early Repolarization',
    searchTerms: ['early repolarization ECG', 'benign early repolarization ECG', 'J point elevation ECG'],
    correctDiagnosis: 'Early Repolarization (Benign)',
    distractors: ['STEMI', 'Pericarditis', 'Brugada Syndrome'],
    visualFindings: 'J point elevation with concave ST elevation, most prominent in V2-V5, young patients',
    clinicalContext: 'Usually benign, especially in young athletes. Distinguish from STEMI/pericarditis.',
    targetImageCount: 12
  },
  {
    conditionId: 'CV__ecg__posterior_stemi',
    name: 'Posterior STEMI',
    searchTerms: ['posterior STEMI ECG', 'posterior MI ECG', 'ST depression V1 V2 V3 reciprocal', 'posterior leads ECG'],
    correctDiagnosis: 'Posterior STEMI',
    distractors: ['Anterior NSTEMI', 'LBBB', 'RVH'],
    visualFindings: 'ST depression in V1-V3 (reciprocal), tall R waves V1-V2, check V7-V9 for ST elevation',
...
async function analyzeECGImage(imageUrl: string, expectedCondition: string, retryCount = 0): Promise<ECGAnalysis | null> {
  if (!genAI) {
...
async function processCondition(condition: ECGCondition, dryRun: boolean): Promise<{ fetched: number; saved: number; errors: number }> {
  ...
  for (const searchTerm of condition.searchTerms) {
    ...
    try {
      ...
      for (const result of results) {
        ...
        if (dryRun) {
          console.log(`    ✅ Would save: ${analysis.detectedRhythm} (score: ${analysis.readabilityScore})`);
          stats.saved++;
          continue;
        }
        ...
        try {
          ...
          console.log(`    ✅ Saved: ${analysis.detectedRhythm} (score: ${analysis.readabilityScore})`);
          stats.saved++;
        } catch (uploadError) {
...
async function main() {
  ...
  if (conditionFilter) {
    conditions = ECG_CONDITIONS.filter(c => 
