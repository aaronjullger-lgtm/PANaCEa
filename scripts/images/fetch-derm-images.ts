...
const DERM_CONDITIONS: DermCondition[] = [
  // =========== INFECTIOUS ===========
  {
    ...
    visualFindings:
      'Grouped vesicles on erythematous base, dermatomal distribution, does NOT cross midline',
    clinicalContext:
      'VZV reactivation. Antivirals within 72 hours. Postherpetic neuralgia risk. Shingrix vaccine prevention.',
    targetImageCount: 12,
  },
  {
    ...
    searchTerms: [
      ...
      'bacterial skin infection children',
      'impetigo bullous',
    ],
    correctDiagnosis: 'Impetigo',
    distractors: ['Herpes Simplex', 'Contact Dermatitis', 'Eczema'],
    visualFindings:
      'Honey-colored crusts, superficial erosions, perioral/perinasal distribution common',
    clinicalContext:
      'S. aureus or Strep pyogenes. Topical mupirocin for limited. Oral antibiotics if extensive.',
    targetImageCount: 10,
  },
  {
    ...
    searchTerms: [
      ...
      'erysipelas',
      'bacterial skin infection spreading',
      'leg cellulitis',
    ],
    correctDiagnosis: 'Cellulitis',
    distractors: ['DVT', 'Contact Dermatitis', 'Stasis Dermatitis'],
    visualFindings:
      'Spreading erythema, warmth, swelling, poorly defined borders, may have lymphangitic streaking',
    clinicalContext:
      'S. aureus, Strep. Antibiotics covering gram-positives. Elevate extremity. Mark borders.',
    targetImageCount: 12,
  },
  {
    ...
    clinicalContext:
      'Dermatophyte fungal infection. KOH prep shows hyphae. Topical antifungals. Oral if extensive.',
    targetImageCount: 10,
  },
  {
    ...
    clinicalContext:
      'Poxvirus. Self-limited in immunocompetent. Cryotherapy or curettage if desired.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Linear burrows, papules/vesicles in web spaces, wrists, genitalia, intense nocturnal pruritus',
    clinicalContext:
      'Sarcoptes scabiei mite. Permethrin 5% cream. Treat all close contacts. Wash bedding/clothing.',
    targetImageCount: 10,
  },
  // =========== INFLAMMATORY ===========
  {
    ...
    searchTerms: [
      'psoriasis plaque',
      'psoriatic lesions',
      'silvery scale psoriasis',
      'psoriasis extensor',
    ],
    correctDiagnosis: 'Plaque Psoriasis',
    distractors: ['Eczema', 'Seborrheic Dermatitis', 'Tinea'],
    visualFindings:
      'Well-demarcated erythematous plaques with silvery scale, Auspitz sign, extensor surfaces/scalp',
    clinicalContext:
      'Chronic autoimmune. Topical steroids/Vitamin D for mild. Biologics for moderate-severe.',
    targetImageCount: 15,
  },
  {
    ...
    visualFindings:
      'Ill-defined erythema, scaling, lichenification, flexural distribution in adults, face in infants',
    clinicalContext:
      'Atopic triad (eczema, asthma, allergic rhinitis). Moisturize, topical steroids. Dupilumab for severe.',
    targetImageCount: 15,
  },
  {
    ...
    visualFindings:
      'Linear or geometric erythema/vesicles conforming to area of contact, may be weeping',
    clinicalContext:
      'Identify and remove allergen/irritant. Topical steroids. Oral steroids if severe/extensive.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Greasy yellowish scales on erythematous base, nasolabial folds, scalp, eyebrows',
    clinicalContext:
      'Associated with Malassezia yeast. Ketoconazole shampoo/cream. May flare with stress, HIV.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Central facial erythema, telangiectasias, papules/pustules (no comedones), rhinophyma in severe',
    clinicalContext:
      'Triggers: sun, alcohol, spicy food. Metronidazole gel, brimonidine for erythema. Oral doxycycline.',
    targetImageCount: 12,
  },
  // =========== NEOPLASTIC ===========
  {
    ...
    visualFindings:
      'ABCDE: Asymmetry, Border irregularity, Color variation, Diameter >6mm, Evolution/change',
    clinicalContext:
      'Most deadly skin cancer. Wide excision. Sentinel node biopsy for staging. Immunotherapy for advanced.',
    targetImageCount: 15,
  },
  {
    ...
    clinicalContext:
      'Most common skin cancer. Rarely metastasizes. Surgical excision, Mohs for high-risk areas.',
    targetImageCount: 15,
  },
  {
    ...
    clinicalContext:
      'Second most common skin cancer. Can metastasize. Surgical excision. From actinic keratoses.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Rough, scaly, erythematous macule/papule on sun-exposed skin, sandpaper texture',
    clinicalContext:
      'Precancerous - can progress to SCC. Cryotherapy, topical 5-FU or imiquimod, photodynamic therapy.',
    targetImageCount: 12,
  },
  // =========== AUTOIMMUNE ===========
  {
    ...
    clinicalContext:
      'Autoimmune destruction of melanocytes. Associated with thyroid disease. Topical steroids, phototherapy.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Butterfly/malar rash sparing nasolabial folds (SLE), or discoid scarring plaques',
    clinicalContext:
      'SLE or isolated cutaneous lupus. ANA, anti-dsDNA for SLE. Sun protection essential.',
    targetImageCount: 12,
  },
  // =========== OTHER ===========
  {
    ...
    visualFindings:
      'Erythematous, edematous wheals with central pallor, transient (<24h), dermographism',
    clinicalContext:
      'IgE-mediated. Antihistamines. If anaphylaxis: epinephrine. Chronic urticaria workup if >6 weeks.',
    targetImageCount: 12,
  },
  {
    conditionId:
      'DERM__reactive__hypersensitivity__henochschnlein_purpura_iga_vasculitis__cutaneous_findings',
    ...
    visualFindings:
      'Target/iris lesions with 3 zones (dark center, pale ring, red outer ring), acral distribution',
    clinicalContext:
      'Often triggered by HSV. Self-limited EM minor. SJS/TEN are severe spectrum - different entity.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Targetoid lesions with epidermal detachment, mucosal involvement (2+ sites), <10% BSA detachment',
    clinicalContext:
      'Drug-induced usually (sulfa, anticonvulsants, allopurinol). Stop culprit drug. Burn unit for TEN (>30%).',
    targetImageCount: 10,
  },
];
...
async function analyzeDermImage(
  imageUrl: string,
  condition: DermCondition,
  retryCount = 0
): Promise<DermAnalysis | null> {
  if (!genAI) {
...
async function processCondition(
  ...
  const existingCount = await prisma.mediaAsset.count({
    where: { conditionId: condition.conditionId, type: 'derm' },
  });
  ...
  for (const searchTerm of condition.searchTerms) {
    ...
    try {
      ...
      for (const result of results) {
        ...
        if (dryRun) {
          console.log(
            `    ✅ Would save: ${analysis.detectedCondition} (Q${analysis.qualityScore})`
          );
          stats.saved++;
          continue;
        }
