...
interface OtherCondition {
  id: string;
  name: string;
  type: 'fundoscopy' | 'otoscopy' | 'throat' | 'ultrasound' | 'blood_smear' | 'clinical_photo' | 'nails' | 'oral';
  searchTerms: string[];
...
const OTHER_CONDITIONS: OtherCondition[] = [
  // =========== FUNDOSCOPY ===========
  {
    ...
    type: 'fundoscopy',
    searchTerms: ['diabetic retinopathy fundus', 'nonproliferative diabetic retinopathy', 'diabetic eye fundoscopy', 'NPDR fundus'],
    correctDiagnosis: 'Diabetic Retinopathy',
    distractors: ['Hypertensive Retinopathy', 'Retinal Vein Occlusion', 'Age-related Macular Degeneration'],
    visualFindings: 'Microaneurysms, dot-blot hemorrhages, hard exudates, cotton wool spots',
    clinicalContext: 'Screen annually. Tight glucose control. Laser for proliferative. Anti-VEGF for macular edema.',
    targetImageCount: 12
  },
  {
    ...
    type: 'fundoscopy',
    searchTerms: ['proliferative diabetic retinopathy fundus', 'PDR neovascularization', 'diabetic retinopathy NVD NVE'],
    correctDiagnosis: 'Proliferative Diabetic Retinopathy',
    distractors: ['NPDR', 'Retinal Vein Occlusion', 'Hypertensive Retinopathy'],
    visualFindings: 'Neovascularization of disc (NVD) or elsewhere (NVE), vitreous hemorrhage, tractional detachment',
    clinicalContext: 'Urgent referral. Panretinal photocoagulation. Anti-VEGF injections. High risk of vision loss.',
    targetImageCount: 10
  },
  {
    ...
    type: 'fundoscopy',
    searchTerms: ['hypertensive retinopathy fundus', 'malignant hypertension fundoscopy', 'hypertensive eye changes', 'grade IV retinopathy'],
    correctDiagnosis: 'Hypertensive Retinopathy',
    distractors: ['Diabetic Retinopathy', 'Retinal Vein Occlusion', 'Papilledema'],
    visualFindings: 'Arteriolar narrowing, AV nicking, flame hemorrhages, cotton wool spots, papilledema in severe',
    clinicalContext: 'Grade severity (Keith-Wagener-Barker). Papilledema = malignant HTN emergency. Control BP.',
    targetImageCount: 10
  },
  // =========== OTOSCOPY ===========
  {
    ...
    type: 'otoscopy',
    searchTerms: ['acute otitis media otoscopy', 'bulging tympanic membrane', 'middle ear infection otoscope', 'AOM otoscopy'],
    correctDiagnosis: 'Acute Otitis Media',
    distractors: ['Otitis Externa', 'Otitis Media with Effusion', 'Bullous Myringitis'],
    visualFindings: 'Bulging, erythematous tympanic membrane, loss of light reflex, may see purulent effusion',
    clinicalContext: 'Common in children. Amoxicillin first-line. Watchful waiting option in mild cases >2yo.',
    targetImageCount: 12
  },
  {
    ...
    type: 'otoscopy',
    searchTerms: ['otitis media effusion otoscopy', 'serous otitis media', 'glue ear otoscopy', 'OME tympanic membrane'],
    correctDiagnosis: 'Otitis Media with Effusion',
    distractors: ['Acute Otitis Media', 'Tympanosclerosis', 'Cholesteatoma'],
    visualFindings: 'Retracted TM, air-fluid level or bubbles behind TM, amber color, decreased mobility',
    clinicalContext: 'Fluid without acute infection. Usually resolves. Myringotomy tubes if chronic with hearing loss.',
    targetImageCount: 10
  },
  // =========== THROAT EXAM ===========
  {
    ...
    type: 'throat',
    searchTerms: ['strep throat pharyngitis', 'exudative tonsillitis', 'strep pharynx exam', 'tonsillar exudates'],
    correctDiagnosis: 'Streptococcal Pharyngitis',
    distractors: ['Viral Pharyngitis', 'Infectious Mononucleosis', 'Peritonsillar Abscess'],
    visualFindings: 'Tonsillar exudates, palatal petechiae, erythematous pharynx, tender cervical adenopathy',
    clinicalContext: 'Centor criteria. Rapid strep or culture. Penicillin/amoxicillin to prevent rheumatic fever.',
    targetImageCount: 12
  },
  {
    ...
    type: 'throat',
    searchTerms: ['peritonsillar abscess throat', 'quinsy exam', 'PTA throat exam', 'uvula deviation abscess'],
    correctDiagnosis: 'Peritonsillar Abscess',
    distractors: ['Severe Tonsillitis', 'Retropharyngeal Abscess', 'Epiglottitis'],
    visualFindings: 'Unilateral tonsillar bulge, uvula deviation to opposite side, trismus, hot potato voice',
    clinicalContext: 'Complication of tonsillitis. Needle aspiration or I&D. IV antibiotics. ENT consult.',
    targetImageCount: 10
  },
  // =========== BLOOD SMEAR ===========
  {
    ...
    type: 'blood_smear',
    searchTerms: ['sickle cell blood smear', 'drepanocytes microscopy', 'sickled red blood cells smear', 'sickle cell peripheral smear'],
    ...
    clinicalContext: 'Hemoglobin SS disease. Vaso-occlusive crises. Hydroxyurea, transfusion, pain management.',
    targetImageCount: 12
  },
  {
    ...
    name: 'Malaria',
    type: 'blood_smear',
    searchTerms: ['malaria blood smear', 'plasmodium smear microscopy', 'ring forms malaria', 'malaria parasite smear'],
    ...
    clinicalContext: 'Travel history endemic areas. Thick smear for screening, thin for speciation. Artemisinin-based therapy.',
    targetImageCount: 10
  },
  // =========== ULTRASOUND ===========
  {
    ...
    type: 'ultrasound',
    searchTerms: ['gallstones ultrasound', 'cholelithiasis sonography', 'gallbladder stones US', 'shadowing gallstones'],
    ...
    clinicalContext: 'Most asymptomatic. Biliary colic = RUQ pain after fatty meals. Elective cholecystectomy if symptomatic.',
    targetImageCount: 10
  },
  {
    ...
    type: 'ultrasound',
    searchTerms: ['acute cholecystitis ultrasound', 'cholecystitis sonography', 'gallbladder wall thickening US', 'sonographic murphy sign'],
    correctDiagnosis: 'Acute Cholecystitis',
    distractors: ['Biliary Colic', 'Pancreatitis', 'Hepatitis'],
    visualFindings: 'Gallbladder wall thickening >3mm, pericholecystic fluid, stones, sonographic Murphy sign',
    clinicalContext: 'RUQ pain, fever, Murphy sign. IV antibiotics, cholecystectomy (early preferred).',
    targetImageCount: 12
  },
  // =========== ORAL FINDINGS ===========
  {
    ...
    type: 'oral',
    searchTerms: ['oral thrush candidiasis', 'white plaques mouth candida', 'oral candida albicans', 'thrush oral exam'],
    ...
    clinicalContext: 'Candida albicans. Risk factors: inhaled steroids, antibiotics, immunocompromise. Nystatin or fluconazole.',
    targetImageCount: 10
  },
  {
    ...
    type: 'clinical_photo',
    searchTerms: ['candidiasis skin', 'cutaneous candidiasis', 'candida intertrigo', 'candida diaper rash'],
    correctDiagnosis: 'Cutaneous Candidiasis',
    distractors: ['Contact dermatitis', 'Psoriasis', 'Tinea'],
    visualFindings: 'Beefy red erythema with satellite papules/pustules, occurs in moist skin folds',
    clinicalContext: 'Moisture + warmth. Keep dry, topical antifungals. Oral fluconazole for severe/recurrent.',
    targetImageCount: 8
  }
];
...
console.log(`📊 OTHER conditions: ${OTHER_CONDITIONS.length} conditions, ${TOTAL_TARGET_IMAGES} total target images`);
...
async function searchRadiopaediaImages(searchTerm: string, limit: number = 5): Promise<any[]> {
  try {
    ...
    return new Promise((resolve) => {
      https.get(searchUrl, { headers: { 'User-Agent': 'PANaCEa-MedicalEducation/1.0' } }, (res) => {
        let html = '';
...
async function analyzeImage(imageUrl: string, condition: OtherCondition): Promise<OtherAnalysis | null> {
...
Respond ONLY with valid JSON.`;
      ...
      if (errorMsg.includes('429') || errorMsg.includes('RESOURCE_EXHAUSTED') || errorMsg.includes('quota')) {
        console.log(`  ⏳ Rate limited (attempt ${attempt}/${maxRetries}), waiting ${RATE_LIMIT.BACKOFF_DELAY_MS/1000}s...`);
...
async function saveMediaAsset(conditionId: string, publicUrl: string, originalUrl: string, condition: OtherCondition, analysis: OtherAnalysis): Promise<void> {
  await prisma.mediaAsset.create({
    data: {
      ...
      aiMetadata: { modalityType: analysis.modalityType, detectedFinding: analysis.detectedFinding },
      status: 'approved',
...
async function processCondition(condition: OtherCondition, dryRun: boolean): Promise<{ fetched: number; saved: number; errors: number }> {
  ...
  if (targetCount <= 0) { console.log(`  ✓ Already have ${existingCount}/${condition.targetImageCount}, skipping`); return stats; }
  ...
  for (const searchTerm of condition.searchTerms) {
    ...
    try {
      ...
      for (const result of results) {
        ...
        if (!analysis?.accept) { console.log(`    ❌ Rejected: ${analysis?.rejectReason || 'Not suitable'}`); continue; }
        
        if (dryRun) { console.log(`    ✅ Would save: ${analysis.detectedFinding} (Q${analysis.qualityScore})`); stats.saved++; continue; }
        
        try {
          const buffer = await fetchImageAsBuffer(result.url);
          const publicUrl = await uploadToSupabase(buffer, `${condition.type}_${Date.now()}.jpg`, condition.type);
          ...
          stats.saved++;
        } catch (e) { console.log(`    ⚠️ Error: ${e}`); stats.errors++; }
        
        await new Promise(r => setTimeout(r, 2000));
      }
    } catch (e) { console.log(`    ⚠️ Search error: ${e}`); stats.errors++; }
...
async function main() {
  ...
  for (const condition of conditions) {
    ...
    totals.fetched += stats.fetched; totals.saved += stats.saved; totals.errors += stats.errors;
  }
  
  console.log('\n' + '='.repeat(60));
  console.log(`📊 OTHER SUMMARY: ${conditions.length} conditions | ${totals.fetched} fetched | ${totals.saved} saved | ${totals.errors} errors`);
