...
const CT_CONDITIONS: CTCondition[] = [
  // =========== HEAD CT ===========
  {
    ...
    searchTerms: [
      'ischemic stroke CT',
      'MCA stroke CT',
      'acute infarct CT brain',
      'cerebral infarction CT',
    ],
    correctDiagnosis: 'Acute Ischemic Stroke',
    distractors: ['Hemorrhagic stroke', 'Brain tumor', 'Subdural hematoma'],
    visualFindings:
      'Loss of gray-white differentiation, sulcal effacement, hyperdense MCA sign (early), wedge-shaped hypodensity (later)',
    clinicalContext:
      'CT first to rule out hemorrhage before tPA. Time is brain - door-to-needle <60min.',
    targetImageCount: 15,
  },
  {
    ...
    searchTerms: [
      ...
      'ICH CT brain',
      'hypertensive hemorrhage CT',
    ],
    correctDiagnosis: 'Intracerebral Hemorrhage',
    distractors: ['Ischemic stroke', 'Hemorrhagic transformation', 'Brain metastasis'],
    visualFindings:
      'Hyperdense (white) collection in brain parenchyma, surrounding edema, possible mass effect',
    clinicalContext:
      'HTN most common cause. Control BP, reverse anticoagulation, neurosurgery consult if large.',
    targetImageCount: 15,
  },
  {
    ...
    searchTerms: [
      ...
      'SDH CT brain',
      'crescent shaped hemorrhage CT',
      'acute subdural CT',
    ],
    correctDiagnosis: 'Subdural Hematoma',
    distractors: ['Epidural hematoma', 'Subarachnoid hemorrhage', 'Chronic subdural hygroma'],
    visualFindings:
      'Crescent-shaped collection crossing suture lines, acute=hyperdense, chronic=hypodense, midline shift',
    clinicalContext:
      'Bridging vein rupture. Common in elderly/alcoholics. May need surgical evacuation.',
    targetImageCount: 15,
  },
  {
    ...
    searchTerms: [
      ...
      'EDH CT brain',
      'lens shaped hemorrhage CT',
      'biconvex hematoma',
    ],
    correctDiagnosis: 'Epidural Hematoma',
    distractors: ['Subdural hematoma', 'Contusion', 'Intracerebral hemorrhage'],
    visualFindings:
      'Biconvex/lens-shaped hyperdense collection, does NOT cross suture lines, often temporal with skull fracture',
    clinicalContext:
      'Middle meningeal artery injury. Classic lucid interval. Surgical emergency - rapid deterioration.',
    targetImageCount: 12,
  },
  {
    ...
    searchTerms: [
      ...
      'SAH CT brain',
      'blood in cisterns CT',
      'aneurysmal SAH CT',
    ],
    correctDiagnosis: 'Subarachnoid Hemorrhage',
    distractors: ['Subdural hematoma', 'Meningitis', 'Normal variant'],
    visualFindings:
      'Hyperdense blood in subarachnoid spaces, basal cisterns, sylvian fissures, interhemispheric fissure',
    clinicalContext:
      'Thunderclap headache, worst of life. Aneurysm most common. CTA/LP if CT negative. Vasospasm risk days 3-14.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Ring-enhancing lesion with central hypodensity, surrounding vasogenic edema, mass effect',
    clinicalContext:
      'Source: sinus, dental, endocarditis. Antibiotics +/- surgical drainage. MRI better for characterization.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Ventricular enlargement out of proportion to sulcal atrophy, Evans index >0.3, periventricular T2 hyperintensity',
    clinicalContext:
      'Classic triad: wet, wobbly, wacky (incontinence, gait apraxia, dementia). VP shunt is treatment.',
    targetImageCount: 10,
  },
  // =========== CHEST CT ===========
  {
    ...
    visualFindings:
      'Filling defect in pulmonary arteries on CTA, saddle embolus at bifurcation, RV strain signs',
    clinicalContext:
      'CTA gold standard. Anticoagulation, thrombolytics if massive, catheter-directed therapy option.',
    targetImageCount: 15,
  },
  {
    ...
    searchTerms: [
      'lung cancer CT',
      'lung mass CT',
      'pulmonary nodule malignant CT',
      'spiculated lung mass',
    ],
    correctDiagnosis: 'Lung Cancer',
    distractors: ['Granuloma', 'Hamartoma', 'Metastasis'],
    visualFindings:
      'Spiculated mass, mediastinal lymphadenopathy, invasion of chest wall/mediastinum, satellite nodules',
    clinicalContext:
      'Smoking biggest risk factor. Staging with PET-CT. Biopsy for tissue diagnosis.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Intimal flap separating true and false lumens, may see differential enhancement',
    clinicalContext:
      'Type A (ascending) = surgical emergency. Type B = medical management unless complicated.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Dilated aorta >4cm (ascending) or >3cm (descending), mural thrombus, calcification',
    clinicalContext:
      'Screen if Marfan, bicuspid aortic valve. Surgical repair if >5.5cm or symptomatic.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Honeycombing (basilar/peripheral), traction bronchiectasis, reticulation, ground glass (minimal)',
    clinicalContext:
      'UIP pattern on HRCT. Poor prognosis. Antifibrotics (pirfenidone, nintedanib). Lung transplant option.',
    targetImageCount: 10,
  },
  // =========== ABDOMINAL CT ===========
  {
    ...
    searchTerms: [
      'appendicitis CT',
      'inflamed appendix CT',
      'appendiceal diameter CT',
    ...
    visualFindings:
      'Dilated appendix >6mm, wall thickening, periappendiceal fat stranding, appendicolith, no contrast filling',
    clinicalContext:
      'RLQ pain, anorexia, migration of pain. CT if diagnosis unclear. Appendectomy treatment of choice.',
    targetImageCount: 15,
  },
  {
    ...
    searchTerms: [
      'diverticulitis CT',
      'sigmoid diverticulitis CT',
      'colonic diverticula inflammation',
      'acute diverticulitis CT',
    ],
    correctDiagnosis: 'Acute Diverticulitis',
    distractors: ['Colon cancer', 'Colitis', 'Epiploic appendagitis'],
    visualFindings:
      'Sigmoid wall thickening, pericolic fat stranding, diverticula, abscess if complicated',
    clinicalContext:
      'LLQ pain in elderly. Uncomplicated = antibiotics (or even observation). Complicated = drainage/surgery.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Dilated proximal bowel >3cm, decompressed distal bowel, transition point, small bowel feces sign',
    clinicalContext:
      'Adhesions most common. CT shows transition point and complications (strangulation, closed loop).',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Hyperdense stone in ureter, hydronephrosis/hydroureter proximal, perinephric stranding, tissue rim sign',
    clinicalContext:
      'Colicky flank pain, hematuria. <5mm usually pass. Alpha blockers for MET. Surgery if >10mm or infected.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Pancreatic enlargement, peripancreatic fat stranding, fluid collections, lack of enhancement (necrosis)',
    clinicalContext:
      'Gallstones and alcohol most common. Supportive care. CT for complications if severe or not improving.',
    targetImageCount: 12,
  },
  {
    ...
    visualFindings:
      'Hypodense lesion with rim enhancement, internal septations, gas (if gas-forming organism)',
    clinicalContext:
      'Pyogenic (biliary, portal) vs amebic. Antibiotics + drainage. Amebic responds to metronidazole.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Gallbladder wall thickening >3mm, pericholecystic fluid/fat stranding, gallstones, + Murphy sign',
    clinicalContext:
      'RUQ pain, fever, positive Murphy. Ultrasound first-line. Cholecystectomy within 72 hours ideal.',
    targetImageCount: 10,
  },
  {
    conditionId: 'CV__vascular_disease__aortic_aneurysm',
    ...
    visualFindings:
      'Aortic diameter >3cm, mural thrombus, calcification, retroperitoneal hemorrhage if ruptured',
    clinicalContext:
      'Rupture = surgical emergency. Screen males 65-75 who smoked. Repair if >5.5cm or symptomatic.',
    targetImageCount: 12,
  },
  // =========== SPINE CT ===========
  {
    ...
    type: 'spine',
    searchTerms: [
      'vertebral compression fracture CT',
      'spine fracture CT',
      'osteoporotic fracture CT',
    ],
    correctDiagnosis: 'Vertebral Compression Fracture',
    distractors: ['Pathologic fracture', 'Schmorl node', 'Degenerative changes'],
    visualFindings:
      'Anterior wedging of vertebral body, loss of height, cortical disruption, possible retropulsion',
    clinicalContext:
      'Osteoporosis common cause. Rule out malignancy. Pain management, vertebroplasty if refractory.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Narrowed central canal, facet hypertrophy, ligamentum flavum thickening, disc bulge',
    clinicalContext:
      'Neurogenic claudication - worse with walking, better leaning forward. MRI better for soft tissue.',
    targetImageCount: 10,
  },
  {
    ...
    visualFindings:
      'Anterior displacement of vertebra, pars interarticularis defect, fracture line if traumatic',
    clinicalContext:
      'May be degenerative or traumatic. CT for bony detail, MRI for ligamentous/cord injury.',
    targetImageCount: 12,
  },
];
...
async function analyzeCTImage(
  imageUrl: string,
  condition: CTCondition,
  retryCount = 0
): Promise<CTAnalysis | null> {
  if (!genAI) {
...
async function main() {
  ...
  console.log(
    `Processing ${conditions.length} conditions (${totalTargetImages} target images)...\n`
  );
