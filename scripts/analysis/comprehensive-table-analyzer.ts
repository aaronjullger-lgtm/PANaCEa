...
async function analyzeAnatomyStructure(): Promise<TableStats> {
  ...
  stats.emptyFields.function = await prisma.anatomyStructure.count({ where: { OR: [{ function: null }, { function: '' }] } });
  stats.emptyFields.innervation = await prisma.anatomyStructure.count({ where: { OR: [{ innervation: null }, { innervation: '' }] } });
  stats.emptyFields.bloodSupply = await prisma.anatomyStructure.count({ where: { OR: [{ bloodSupply: null }, { bloodSupply: '' }] } });
  stats.emptyFields.clinicalSignificance = await prisma.anatomyStructure.count({ where: { OR: [{ clinicalSignificance: null }, { clinicalSignificance: '' }] } });
  stats.emptyFields.description = await prisma.anatomyStructure.count({ where: { OR: [{ description: null }, { description: '' }] } });
  stats.emptyFields.clinicalPearls = await prisma.anatomyStructure.count({ where: { clinicalPearls: { isEmpty: true } } });
  stats.emptyFields.mnemonics = await prisma.anatomyStructure.count({ where: { mnemonics: { isEmpty: true } } });
  stats.emptyFields.boardYieldFacts = await prisma.anatomyStructure.count({ where: { boardYieldFacts: { isEmpty: true } } });
  stats.emptyFields.testQuestionTips = await prisma.anatomyStructure.count({ where: { testQuestionTips: { isEmpty: true } } });
  stats.emptyFields.commonMistakes = await prisma.anatomyStructure.count({ where: { commonMistakes: { isEmpty: true } } });
  stats.emptyFields.origin = await prisma.anatomyStructure.count({ where: { OR: [{ origin: null }, { origin: '' }] } });
  stats.emptyFields.insertion = await prisma.anatomyStructure.count({ where: { OR: [{ insertion: null }, { insertion: '' }] } });
  stats.emptyFields.motorFunction = await prisma.anatomyStructure.count({ where: { OR: [{ motorFunction: null }, { motorFunction: '' }] } });
...
async function analyzePhysiologyConcept(): Promise<TableStats> {
  ...
  stats.emptyFields.mechanism = await prisma.physiologyConcept.count({ where: { OR: [{ mechanism: null }, { mechanism: '' }] } });
  stats.emptyFields.clinicalSignificance = await prisma.physiologyConcept.count({ where: { OR: [{ clinicalSignificance: null }, { clinicalSignificance: '' }] } });
  stats.emptyFields.normalValues = await prisma.physiologyConcept.count({ where: { OR: [{ normalValues: null }, { normalValues: '' }] } });
  stats.emptyFields.pathophysiology = await prisma.physiologyConcept.count({ where: { OR: [{ pathophysiology: null }, { pathophysiology: '' }] } });
  stats.emptyFields.clinicalPearls = await prisma.physiologyConcept.count({ where: { clinicalPearls: { isEmpty: true } } });
  stats.emptyFields.mnemonics = await prisma.physiologyConcept.count({ where: { mnemonics: { isEmpty: true } } });
  stats.emptyFields.relatedConditions = await prisma.physiologyConcept.count({ where: { relatedConditions: { isEmpty: true } } });
  stats.emptyFields.relatedDrugs = await prisma.physiologyConcept.count({ where: { relatedDrugs: { isEmpty: true } } });
  stats.emptyFields.boardYieldFacts = await prisma.physiologyConcept.count({ where: { boardYieldFacts: { isEmpty: true } } });
  stats.emptyFields.testQuestionTips = await prisma.physiologyConcept.count({ where: { testQuestionTips: { isEmpty: true } } });
  stats.emptyFields.commonMistakes = await prisma.physiologyConcept.count({ where: { commonMistakes: { isEmpty: true } } });
...
async function analyzePhysicalExamFinding(): Promise<TableStats> {
  ...
  stats.emptyFields.description = await prisma.physicalExamFinding.count({ where: { OR: [{ description: null }, { description: '' }] } });
  stats.emptyFields.howToElicit = await prisma.physicalExamFinding.count({ where: { OR: [{ howToElicit: null }, { howToElicit: '' }] } });
  stats.emptyFields.clinicalSignificance = await prisma.physicalExamFinding.count({ where: { OR: [{ clinicalSignificance: null }, { clinicalSignificance: '' }] } });
  stats.emptyFields.sensitivity = await prisma.physicalExamFinding.count({ where: { sensitivity: null } });
  stats.emptyFields.specificity = await prisma.physicalExamFinding.count({ where: { specificity: null } });
  stats.emptyFields.positiveIndicates = await prisma.physicalExamFinding.count({ where: { positiveIndicates: { isEmpty: true } } });
  stats.emptyFields.clinicalPearls = await prisma.physicalExamFinding.count({ where: { clinicalPearls: { isEmpty: true } } });
  stats.emptyFields.mnemonics = await prisma.physicalExamFinding.count({ where: { mnemonics: { isEmpty: true } } });
  stats.emptyFields.boardYieldFacts = await prisma.physicalExamFinding.count({ where: { boardYieldFacts: { isEmpty: true } } });
  stats.emptyFields.testQuestionTips = await prisma.physicalExamFinding.count({ where: { testQuestionTips: { isEmpty: true } } });
  stats.emptyFields.commonMistakes = await prisma.physicalExamFinding.count({ where: { commonMistakes: { isEmpty: true } } });
...
async function analyzeMedicalContent(): Promise<TableStats> {
  ...
  stats.emptyFields.overview = await prisma.medicalContent.count({ where: { OR: [{ overview: null }, { overview: '' }] } });
  stats.emptyFields.epidemiology = await prisma.medicalContent.count({ where: { OR: [{ epidemiology: null }, { epidemiology: '' }] } });
  stats.emptyFields.etiology = await prisma.medicalContent.count({ where: { OR: [{ etiology: null }, { etiology: '' }] } });
  stats.emptyFields.pathophysiology = await prisma.medicalContent.count({ where: { OR: [{ pathophysiology: null }, { pathophysiology: '' }] } });
  stats.emptyFields.symptoms = await prisma.medicalContent.count({ where: { OR: [{ symptoms: null }, { symptoms: '' }] } });
  stats.emptyFields.physicalExam = await prisma.medicalContent.count({ where: { OR: [{ physicalExam: null }, { physicalExam: '' }] } });
  stats.emptyFields.diagnostics = await prisma.medicalContent.count({ where: { OR: [{ diagnostics: null }, { diagnostics: '' }] } });
  stats.emptyFields.treatment = await prisma.medicalContent.count({ where: { OR: [{ treatment: null }, { treatment: '' }] } });
