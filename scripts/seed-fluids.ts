...
const FLUID_CASES: FluidCaseSeed[] = [
  {
    title: 'AKI Etiology',
    scenario: 'A 68-year-old man presents with 3 days of decreased urine output. He has a history of heart failure and was started on furosemide 2 days ago. Physical exam shows dry mucous membranes and decreased skin turgor.',
    labs: {
      bmp: {
        sodium: 142,
        potassium: 4.2,
  ...
  },
  {
    ...
    scenario: 'A 25 kg 6-year-old is admitted for appendicitis and needs maintenance IV fluids while NPO before surgery.',
    labs: {
      bmp: {
        sodium: 138,
        potassium: 4.0,
  ...
  {
    title: 'Anion Gap',
    scenario: 'A 28-year-old diabetic presents with nausea, vomiting, and confusion. Blood glucose is 450 mg/dL.',
    labs: {
      bmp: {
        sodium: 135,
        potassium: 5.2,
  ...
  },
  {
    ...
    scenario: 'A 70 kg man is found unresponsive at home. He has been without water for several days.',
    labs: {
      bmp: {
        sodium: 160,
        potassium: 4.5,
  ...
  },
  {
    ...
    scenario: 'A 65-year-old woman with chronic hyponatremia (Na 118) from SIADH needs correction rate calculated.',
    labs: {
      bmp: {
        sodium: 118,
        potassium: 3.8,
    ...
    unit: 'mEq/L/hr',
    marginOfError: 0.1,
    explanation: 'Safe correction rate for chronic hyponatremia is 0.5 mEq/L/hr or 10-12 mEq/L per day to avoid osmotic demyelination syndrome. Faster correction only for severe symptoms.',
  ...
  },
  {
    ...
    scenario: 'A 55-year-old with persistent vomiting for 3 days. Concerned about metabolic alkalosis.',
    labs: {
      bmp: {
        sodium: 140,
        potassium: 2.8,
    ...
    unit: 'mEq/L',
    marginOfError: 2,
    explanation: 'Anion Gap = 140 - (88 + 38) = 14 mEq/L. Normal anion gap with elevated bicarbonate indicates non-anion gap metabolic alkalosis from vomiting (loss of HCl).',
    calculationHint: 'Anion Gap = Na - (Cl + HCO3)',
    category: 'anion_gap',
    difficulty: 'medium'
  },
  {
    ...
    unit: 'mL/hr',
    marginOfError: 3,
    explanation: 'Using 4-2-1 rule for 8 kg infant: First 10 kg uses 4 mL/kg/hr. 8 kg × 4 mL/kg/hr = 32 mL/hr maintenance.',
  ...
  {
    title: 'Uremic AKI',
    scenario: 'A 72-year-old with CKD presents with confusion and decreased urine output. Suspect intrinsic AKI.',
    labs: {
      bmp: {
        sodium: 138,
        potassium: 5.8,
    ...
    unit: '%',
    marginOfError: 0.3,
    explanation: 'FENa = [(48 × 4.5) / (138 × 85)] × 100 = 2.7%. FENa >2% indicates intrinsic AKI (acute tubular necrosis in this case).',
    calculationHint: 'FENa = [(UNa × SCr) / (SNa × UCr)] × 100',
    category: 'fena',
    difficulty: 'medium'
  },
  {
    title: 'DKA Anion Gap',
    scenario: 'A 19-year-old type 1 diabetic presents with abdominal pain and Kussmaul respirations. Glucose 580.',
    labs: {
      bmp: {
        sodium: 132,
        potassium: 5.4,
    ...
    unit: 'mEq/L',
    marginOfError: 2,
    explanation: 'Anion Gap = 132 - (95 + 8) = 29 mEq/L. Severely elevated anion gap with low bicarbonate = DKA (ketoacids causing high anion gap metabolic acidosis).',
    calculationHint: 'Anion Gap = Na - (Cl + HCO3)',
    category: 'anion_gap',
    difficulty: 'easy'
  },
  {
    ...
    scenario: 'An 80 kg elderly man admitted from nursing home with altered mental status. Serum Na 155.',
    labs: {
      bmp: {
        sodium: 155,
        potassium: 4.2,
    ...
    unit: 'L',
    marginOfError: 0.5,
    explanation: 'Free Water Deficit = 0.6 × 80 × [(155/140) - 1] = 48 × 0.107 = 5.1 L. Gradual correction needed over 48 hours to avoid cerebral edema.',
...
async function seedFluidCases() {
  ...
  try {
    ...
    for (const fluidCase of FLUID_CASES) {
      ...
      difficultyStats[fluidCase.difficulty || 'medium'] = (difficultyStats[fluidCase.difficulty || 'medium'] || 0) + 1;
