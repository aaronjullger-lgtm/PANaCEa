...
const BUZZWORD_DATA = {
  ...
  "Aortic Stenosis": { buzzword: "Harsh systolic crescendo-decrescendo (RUSB)", category: "Cardio" },
  ...
  "Atrial Fibrillation": { buzzword: "Irregularly irregular + No P waves", category: "Cardio (ECG)" },
  "Acute Pericarditis": { buzzword: "Diffuse ST elevation + PR depression", category: "Cardio (ECG)" },
  "Pericardial Effusion": { buzzword: "Electrical Alternans / Water Bottle Heart", category: "Cardio" },
  ...
  "Infective Endocarditis": { buzzword: "Janeway Lesions / Osler Nodes / Roth Spots", category: "Cardio (Clinical)" },
  ...
  // NEURO
  "Subarachnoid Hemorrhage": { buzzword: "'Thunderclap' headache / Star pattern", category: "Neuro" },
  "Multiple Sclerosis": { buzzword: "Dawson’s Fingers / Oligoclonal bands / Lhermitte’s", category: "Neuro" },
  ...
  // ENDO
  "Hypercalcemia": { buzzword: "'Stones, bones, abdominal groans, psychiatric moans'", category: "Endo" },
