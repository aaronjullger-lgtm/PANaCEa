...
const CONDITION_ALIASES: Record<string, string[]> = {
  ...
  "Conversion Disorder (Functional Neurological Symptom Disorder)": ["Conversion Disorder", "Functional Neurological Disorder"],
  ...
  "Intellectual Disability (Intellectual Developmental Disorder)": ["Mental Retardation", "Intellectual Developmental Disorder"],
  ...
  "Addison Disease (Primary Adrenal Insufficiency)": ["Addison's Disease", "Primary Adrenal Insufficiency"],
...
function main() {
  ...
  for (const [conditionName, aliases] of Object.entries(CONDITION_ALIASES)) {
    ...
    const patternNoAlias = new RegExp(
      `(\\{[^}]*condition:\\s*"${escapedName}"\\s*)\\}`,
      'g'
    );
