...
const MSK_HIERARCHY: Record<string, { parent: string; keywords: string[] }> = {
  ...
  'Lower Extremity - Knee': {
    parent: 'Lower Extremity Disorders',
    keywords: ['knee', 'patella', 'meniscus', 'acl', 'pcl', 'mcl', 'lcl', 'osgood-schlatter', 'extensor mechanism']
  },
  ...
  'Upper Extremity - Shoulder': {
    ...
    keywords: ['shoulder', 'clavicle', 'scapula', 'acromioclavicular', 'rotator cuff', 'glenohumeral']
  },
  ...
  'Upper Extremity - Wrist/Hand': {
    parent: 'Upper Extremity Disorders',
    keywords: ['wrist', 'hand', 'carpal', 'metacarpal', 'phalange', 'finger', 'thumb', 'scaphoid', 'boxer']
  },
  ...
  'Spinal - Thoracic': {
    parent: 'Spinal Disorders',
    keywords: ['thoracic spine', 't1', 't2', 't3', 't4', 't5', 't6', 't7', 't8', 't9', 't10', 't11', 't12', 'kyphosis']
  },
  'Spinal - Lumbar': {
    parent: 'Spinal Disorders',
...
const DERM_HIERARCHY: Record<string, { parent: string; keywords: string[] }> = {
  'Infectious - Bacterial': {
    ...
    keywords: ['cellulitis', 'erysipelas', 'impetigo', 'folliculitis', 'furuncle', 'carbuncle', 'abscess', 'bacterial']
  },
  'Infectious - Fungal': {
    parent: 'Infectious Diseases',
  ...
  'Infectious - Viral': {
    parent: 'Infectious Diseases',
    keywords: ['condyloma', 'exanthem', 'hand-foot-and-mouth', 'herpes', 'molluscum', 'varicella', 'zoster', 'verruca', 'wart', 'viral', 'hpv']
  }
};
...
async function categorizeMSKDermConditions() {
  ...
  for (const condition of conditions) {
    ...
    if (condition.system === 'Musculoskeletal System') {
      ...
      // Check for Chest/Rib
      if (!matched && (nameLower.includes('chest') || nameLower.includes('rib') || nameLower.includes('sternum'))) {
