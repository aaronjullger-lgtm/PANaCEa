      ...
      try {
        ...
        await prisma.specialTest.create({
          data: {
            ...
            positiveResult: ensureString(data.positiveResult),
            negativeResult: ensureString(data.negativeResult),
            ...
            indicatedFor: ensureArray(data.indicatedFor),
            contraindications: ensureArray(data.contraindications),
            commonPitfalls: ensureArray(data.commonPitfalls),
            ...
            alternativeNames: ensureArray(data.alternativeNames),
            updatedAt: new Date(),
          },
        });
