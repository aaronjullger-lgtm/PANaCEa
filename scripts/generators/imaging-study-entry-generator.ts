      ...
      try {
        ...
        await prisma.imagingStudy.create({
          data: {
            ...
            protocol: ensureString(data.technique),
            ...
            classicSigns: ensureArray(data.abnormalFindings),
            ...
            contrastAgent: ensureString(data.contrastConsiderations),
            clinicalPearls: ensureArray(data.clinicalPearls),
            boardYieldFacts: ensureArray(data.boardYieldFacts),
            indications: ensureArray(data.whenToOrder),
            alternativeTo: ensureArray(data.alternativeStudies),
            updatedAt: new Date(),
          },
        });
