...
const KNOWN_STUDIES: KnownStudy[] = [
  // ========== CHEST X-RAY ==========
  {
    ...
    clinicalPearls: [
      'Always check for free air under diaphragm on upright',
      'Lateral view sees retrocardiac pathology',
    ],
  },
  {
    ...
    classicSigns: [],
    clinicalPearls: [
      'Heart appears enlarged on AP - cannot assess cardiomegaly',
      'Tip of ET tube should be 2-4cm above carina',
    ],
  },
  ...
  // ========== ABDOMINAL IMAGING ==========
  {
    ...
    clinicalPearls: [
      '90% of kidney stones are radiopaque',
      'Only 10-15% of gallstones visible',
      'Get upright to see free air',
    ],
  },
  {
    ...
    clinicalPearls: [
      'Oral contrast rarely needed acutely',
      'Consider non-contrast for renal colic',
    ],
  },
  {
    ...
    clinicalPearls: [
      ...
      'Can measure stone size and location for treatment planning',
    ],
  },
  {
    ...
    limitations: [
      'Operator dependent',
      'Limited by body habitus/gas',
      'Cannot see through bone/air',
    ],
    classicSigns: [
    ...
    clinicalPearls: [
      'Sonographic Murphy sign is highly specific for cholecystitis',
      'CBD >6mm suggests obstruction (>10mm post-cholecystectomy)',
    ],
  },
  {
    ...
    clinicalPearls: [
      'Combine with transvaginal for complete evaluation',
      'First trimester dating most accurate <14 weeks',
    ],
  },
  {
    ...
    advantages: [
      ...
      'Empty bladder OK',
      'Better ovarian visualization',
    ],
    limitations: ['More invasive', 'Requires patient cooperation'],
    classicSigns: [
      'Ring of fire (corpus luteum)',
      'Tubal ring sign (ectopic)',
      'String of pearls (PCOS)',
      'Whirlpool sign (torsion)',
    ],
    clinicalPearls: [
      'Gestational sac visible at β-hCG 1500-2000',
      'No IUP with positive β-hCG = ectopic until proven otherwise',
    ],
  },
  {
    ...
    advantages: [
      ...
      'No radiation',
      'Repeatable',
      'Guides OR vs observation',
    ],
    limitations: [
      'Cannot quantify bleeding',
      'Misses retroperitoneal injury',
      'Operator dependent',
    ],
    classicSigns: ['Anechoic stripe in Morrison pouch', 'Pericardial effusion'],
    clinicalPearls: [
      'Four windows: RUQ, LUQ, Pelvis, Pericardial',
  ...
  // ========== HEAD IMAGING ==========
  {
    ...
    limitations: [
      'Less sensitive for early ischemia (<6 hours)',
      'Poor posterior fossa visualization',
      'Radiation',
    ],
    classicSigns: [
      'Hyperdense MCA sign (clot)',
      'Loss of gray-white differentiation',
      'Sulcal effacement',
      'Midline shift',
    ],
    clinicalPearls: [
      'ALWAYS non-contrast first for stroke (rule out bleed before tPA)',
      'Subarachnoid blood is hyperdense in sulci',
    ],
  },
  {
    ...
    classicSigns: [
      'Dawson fingers (MS)',
      'Ring-enhancing lesion (abscess/tumor)',
      'Empty sella',
      'Leptomeningeal enhancement',
    ],
    clinicalPearls: [
      'DWI (diffusion) shows acute stroke within minutes',
      'MS lesions perpendicular to ventricles',
    ],
  },
  {
    ...
    clinicalPearls: [
      'Order with stroke workup to identify large vessel occlusion for thrombectomy candidacy',
    ],
  },
  ...
  // ========== SPINE IMAGING ==========
  {
    ...
    limitations: [
      'Poor sensitivity for fractures',
      'Cannot see soft tissue/disc/cord',
      'Often inadequate views',
    ],
    classicSigns: ['Prevertebral swelling', 'Loss of lordosis', 'Widened interspinous distance'],
    clinicalPearls: [
      'CT has replaced X-ray for trauma in most settings',
  ...
  },
  {
    ...
    clinicalPearls: [
      'Order CT for any high-risk trauma per NEXUS/CCR criteria',
      'Add MRI if neurologic symptoms',
    ],
  },
  {
    ...
    clinicalPearls: [
      'Red flags requiring urgent MRI: bowel/bladder symptoms, saddle anesthesia, progressive weakness, infection signs',
    ],
  },
  ...
  // ========== MUSCULOSKELETAL ==========
  {
    ...
    clinicalPearls: [
      'Always get 2 views at 90 degrees',
      'Include joint above and below',
      'Ottawa rules guide when to image',
    ],
  },
  {
  ...
  },
  {
    ...
    clinicalPearls: [
      'MR arthrogram superior for labral pathology',
  ...
  // ========== CARDIOVASCULAR ==========
  {
    ...
    limitations: [
      ...
      'Some structures poorly visualized',
    ],
    classicSigns: [
      'Reduced EF (<40%)',
      'Regurgitant jets',
    ...
    clinicalPearls: [
      ...
      'TEE better for endocarditis vegetations and LA appendage',
    ],
  },
  {
    ...
    indications: [
      'Suspected PE',
      'Dyspnea with elevated D-dimer',
      'Hemodynamic instability with RV strain',
    ],
    ...
    classicSigns: [
      ...
      'Saddle embolus',
      'RV dilation (>1:1 RV:LV ratio)',
    ],
    clinicalPearls: [
      'Use Wells criteria first - if low probability, D-dimer can rule out',
      'RV strain indicates massive/submassive PE',
    ],
  },
  {
    ...
    indications: [
      'Suspected PE with contrast allergy',
      'Renal insufficiency',
      'Pregnancy (lower radiation than CT)',
    ],
    ...
    clinicalPearls: [
      'High probability V/Q = PE, normal V/Q = rules out PE, intermediate requires further testing',
    ],
  },
  {
    ...
    clinicalPearls: [
      'Compression is key - normal vein collapses completely',
      'If negative but high suspicion, repeat in 5-7 days',
    ],
  },
  ...
  // ========== GI/HEPATOBILIARY ==========
  {
    ...
    indications: [
      'Suspected acute cholecystitis with equivocal US',
      'Biliary dyskinesia',
      'Bile leak',
    ],
    ...
    classicSigns: [
      'Non-visualization of gallbladder = positive for cholecystitis',
      'Rim sign (severe cholecystitis)',
    ],
    clinicalPearls: [
      '95% sensitivity for acute cholecystitis',
      'CCK-HIDA for biliary dyskinesia - EF <35% abnormal',
    ],
  },
  {
  ...
  },
  {
    ...
    clinicalPearls: [
      'Better than standard CT for inflammatory bowel disease',
  ...
  },
  {
    ...
    classicSigns: [
      ...
      'Hypoechoic mass (cancer)',
      'Whirlpool sign (torsion)',
    ],
    clinicalPearls: [
      'SURGICAL EMERGENCY: No flow + high clinical suspicion = OR without delay',
      'Torsion is clinical diagnosis - do not delay surgery for imaging',
    ],
  },
  ...
  // ========== OBSTETRIC ==========
  {
    ...
    clinicalPearls: [
      'CRL most accurate dating <14 weeks',
      'No embryo with mean sac diameter >25mm = pregnancy failure',
    ],
  },
  {
    ...
    classicSigns: [
      'Lemon sign (neural tube defect)',
      'Double bubble (duodenal atresia)',
      'Echogenic bowel',
    ],
    clinicalPearls: [
      'Best window 18-22 weeks for anatomy',
      'Low-lying placenta often resolves by third trimester',
    ],
  },
  ...
  // ========== THYROID/NECK ==========
  {
    ...
    classicSigns: [
      'TI-RADS criteria',
      'Microcalcifications (cancer)',
      'Hypoechoic nodule',
      'Irregular margins',
    ],
    clinicalPearls: [
      'ACR TI-RADS guides FNA decision',
      'Microcalcifications highly suspicious for papillary cancer',
    ],
  },
  ...
  // ========== BREAST ==========
  {
    ...
    clinicalPearls: [
      'BI-RADS categories guide management',
      'Dense breasts may need supplemental screening (US or MRI)',
    ],
  },
  {
    ...
    indications: [
      'Palpable mass',
      'Mammographic abnormality workup',
      'Dense breasts',
      'Young patients',
    ],
    contraindications: ['None'],
  ...
  // ========== BONE/NUCLEAR ==========
  {
    ...
    classicSigns: [
      ...
      'Superscan (diffuse metastases)',
      'Cold spots (avascular)',
    ],
    clinicalPearls: [
      'Positive 2-3 days after fracture',
      'Prostate cancer shows hot spots, myeloma may be cold',
    ],
  },
  {
  ...
  // ========== INTERVENTIONAL/ANGIOGRAPHY ==========
  {
    ...
    advantages: [
      ...
      'Can treat (PCI/stent) at same time',
    ...
    clinicalPearls: [
      'Door-to-balloon <90 minutes for STEMI',
      'Left main or 3-vessel disease may need CABG',
    ],
  },
  ...
  // ========== PET ==========
  {
    ...
    clinicalPearls: [
      'Not for initial diagnosis - for staging/monitoring',
      'Patient must fast, glucose <200',
    ],
  },
];
