...
const ANATOMY_STRUCTURES = [
  ...
  { name: 'Anterior Cruciate Ligament', system: 'MSK', region: 'Lower Extremity', type: 'Ligament' },
...
async function generateAnatomyContent(structure: typeof ANATOMY_STRUCTURES[0]): Promise<AnatomyAIResponse> {
