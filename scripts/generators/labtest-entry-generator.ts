...
const COMMON_LABS = [
  // Basic Chemistry
  {
    name: 'Anion Gap',
    category: 'Metabolic',
    typicalUse: 'Metabolic acidosis workup, identifying causes of acidosis',
  },
  {
    name: 'Bicarbonate (HCO3)',
    category: 'Electrolytes',
    typicalUse: 'Acid-base status evaluation, metabolic disorders',
  },
  {
    name: 'BUN/Creatinine Ratio',
    category: 'Renal',
    typicalUse: 'Differentiating prerenal from renal causes of azotemia',
  },
  {
    name: 'Chloride (Cl)',
    category: 'Electrolytes',
    typicalUse: 'Electrolyte imbalance, metabolic disorders',
  },
  ...
  // Hematology
  {
    ...
    category: 'Hematology',
    typicalUse: 'Infection risk assessment, chemotherapy monitoring',
  },
  {
    name: 'Absolute Lymphocyte Count',
    category: 'Hematology',
    typicalUse: 'Immune function assessment, HIV monitoring',
  },
  {
    name: 'Immature Platelet Fraction (IPF)',
    category: 'Hematology',
    typicalUse: 'Thrombocytopenia evaluation, bone marrow function',
  },
  {
    name: 'Nucleated RBC Count',
    category: 'Hematology',
    typicalUse: 'Hemolysis, bone marrow stress, newborn evaluation',
  },
  ...
  { name: 'Pro-BNP', category: 'Cardiac', typicalUse: 'Heart failure diagnosis and monitoring' },
  {
    ...
    category: 'Cardiac',
    typicalUse: 'Cardiovascular risk assessment, inflammation',
  },
  {
    name: 'Homocysteine',
    category: 'Cardiac',
    typicalUse: 'Cardiovascular risk assessment, B12/folate deficiency',
  },
  ...
  // Liver
  {
    ...
    category: 'Hepatic',
    typicalUse: 'Conjugated hyperbilirubinemia, cholestasis',
  },
  {
    name: 'Indirect Bilirubin',
    category: 'Hepatic',
    typicalUse: 'Unconjugated hyperbilirubinemia, hemolysis',
  },
  {
    name: 'AST/ALT Ratio',
    category: 'Hepatic',
    typicalUse: 'Differentiating liver disease etiology',
  },
  {
    name: 'GGTP (GGT)',
    category: 'Hepatic',
    typicalUse: 'Cholestasis, alcohol use, hepatobiliary disease',
  },
  ...
  { name: 'Free T4', category: 'Endocrine', typicalUse: 'Thyroid function evaluation' },
  {
    name: 'Free T3',
    category: 'Endocrine',
    typicalUse: 'Hyperthyroidism evaluation, thyroid function',
  },
  {
    name: 'Reverse T3',
    category: 'Endocrine',
    typicalUse: 'Euthyroid sick syndrome, non-thyroidal illness',
  },
  {
    name: 'Anti-TPO Antibodies',
    category: 'Endocrine',
    typicalUse: 'Autoimmune thyroid disease diagnosis',
  },
  { name: 'Random Cortisol', category: 'Endocrine', typicalUse: 'Adrenal function screening' },
  {
    name: '1-Hour Post-Glucose Load',
    category: 'Endocrine',
    typicalUse: 'Gestational diabetes screening',
  },
  {
    name: '2-Hour Post-Glucose Load',
    category: 'Endocrine',
    typicalUse: 'Diabetes diagnosis, OGTT',
  },
  {
    name: 'Fasting Insulin',
    category: 'Endocrine',
    typicalUse: 'Insulin resistance, hyperinsulinemia',
  },
  ...
  // Coagulation
  {
    ...
    typicalUse: 'Fibrinogen abnormalities, heparin effect',
  },
  {
    name: 'Fibrinogen',
    category: 'Coagulation',
    typicalUse: 'DIC workup, coagulation disorders, inflammation',
  },
  ...
  { name: 'Prothrombin G20210A', category: 'Coagulation', typicalUse: 'Thrombophilia evaluation' },
  {
    ...
    category: 'Coagulation',
    typicalUse: 'Thrombophilia evaluation, heparin resistance',
  },
  {
    name: 'Mixing Study',
    category: 'Coagulation',
    typicalUse: 'Prolonged PTT workup - factor deficiency vs inhibitor',
  },
  {
    name: 'Lupus Anticoagulant',
    category: 'Coagulation',
    typicalUse: 'Antiphospholipid syndrome, thrombophilia',
  },
  ...
  { name: 'Urine Sodium', category: 'Renal', typicalUse: 'Volume status, AKI differentiation' },
  {
    ...
    category: 'Renal',
    typicalUse: 'AKI differentiation - prerenal vs ATN',
  },
  {
    name: 'Urine Osmolality',
    category: 'Renal',
    typicalUse: 'Concentrating ability, SIADH workup',
  },
  {
    name: 'Urine Specific Gravity',
    category: 'Renal',
    typicalUse: 'Hydration status, concentrating ability',
  },
  {
    name: 'Cystatin C',
    category: 'Renal',
    typicalUse: 'GFR estimation, especially in muscle wasting',
  },
  {
    name: 'Spot Urine Protein/Creatinine Ratio',
    category: 'Renal',
    typicalUse: 'Proteinuria quantification',
  },
  {
    name: '24-Hour Urine Protein',
    category: 'Renal',
    typicalUse: 'Nephrotic syndrome quantification',
  },
  ...
  // Infectious Disease
  {
    ...
    typicalUse: 'Bacteremia/septicemia diagnosis',
  },
  {
    name: 'Urine Culture',
    category: 'Infectious Disease',
    typicalUse: 'UTI diagnosis, pathogen identification',
  },
  {
    name: 'Wound Culture',
    category: 'Infectious Disease',
    typicalUse: 'Wound infection diagnosis',
  },
  { name: 'CSF Culture', category: 'Infectious Disease', typicalUse: 'Meningitis diagnosis' },
  {
    name: 'Stool Culture',
    category: 'Infectious Disease',
    typicalUse: 'Bacterial gastroenteritis diagnosis',
  },
  {
    name: 'Rapid Strep Test',
    category: 'Infectious Disease',
    typicalUse: 'Group A strep pharyngitis diagnosis',
  },
  {
    name: 'COVID-19 PCR',
    category: 'Infectious Disease',
    typicalUse: 'SARS-CoV-2 infection diagnosis',
  },
  {
    name: 'COVID-19 Antigen',
    category: 'Infectious Disease',
    typicalUse: 'Rapid SARS-CoV-2 detection',
  },
  {
    name: 'Rapid Flu Test',
    category: 'Infectious Disease',
    typicalUse: 'Influenza A/B rapid detection',
  },
  {
    name: 'C. difficile Toxin',
    category: 'Infectious Disease',
    typicalUse: 'C. diff colitis diagnosis',
  },
  {
    name: 'Quantiferon-TB Gold',
    category: 'Infectious Disease',
    typicalUse: 'Latent TB infection diagnosis',
  },
  ...
  { name: 'Urine pH', category: 'Urinalysis', typicalUse: 'Acidification disorders, stone risk' },
  {
    ...
    category: 'Urinalysis',
    typicalUse: 'Pyuria detection, UTI screening',
  },
  {
    name: 'Urine RBC',
    category: 'Urinalysis',
    typicalUse: 'Hematuria detection, glomerular disease',
  },
  ...
  // Immunology
  {
    ...
    category: 'Immunology',
    typicalUse: 'Rheumatoid arthritis diagnosis',
  },
  {
    name: 'Anti-dsDNA Antibodies',
    category: 'Immunology',
    typicalUse: 'SLE diagnosis and activity',
  },
  { name: 'Anti-Smith Antibodies', category: 'Immunology', typicalUse: 'SLE-specific antibody' },
  {
    name: 'Anti-SSA/Ro Antibodies',
    category: 'Immunology',
    typicalUse: 'Sjögren syndrome, SLE, neonatal lupus',
  },
  { name: 'Anti-SSB/La Antibodies', category: 'Immunology', typicalUse: 'Sjögren syndrome' },
  {
    name: 'C3 Complement',
    category: 'Immunology',
    typicalUse: 'Complement consumption, SLE activity',
  },
  {
    name: 'C4 Complement',
    category: 'Immunology',
    typicalUse: 'Complement consumption, hereditary angioedema',
  },
  {
    name: 'Quantitative Immunoglobulins',
    category: 'Immunology',
    typicalUse: 'Immunodeficiency, multiple myeloma',
  },
  ...
  // Tumor Markers
  {
    ...
    typicalUse: 'Colorectal cancer monitoring',
  },
  {
    name: 'AFP (Alpha-Fetoprotein)',
    category: 'Tumor Markers',
    typicalUse: 'Liver cancer, germ cell tumors',
  },
  {
    name: 'Beta-hCG',
    category: 'Tumor Markers',
    typicalUse: 'Pregnancy, gestational trophoblastic disease',
  },
  {
    name: 'LDH (Lactate Dehydrogenase)',
    category: 'Tumor Markers',
    typicalUse: 'Tumor burden, hemolysis, tissue damage',
  },
  ...
  { name: 'Digoxin Level', category: 'Toxicology', typicalUse: 'Digoxin therapeutic monitoring' },
  {
    ...
    category: 'Toxicology',
    typicalUse: 'Vancomycin therapeutic monitoring',
  },
  {
    name: 'Gentamicin Level',
    category: 'Toxicology',
    typicalUse: 'Aminoglycoside therapeutic monitoring',
  },
  { name: 'Phenytoin Level', category: 'Toxicology', typicalUse: 'Seizure medication monitoring' },
  {
    name: 'Valproic Acid Level',
    category: 'Toxicology',
    typicalUse: 'Seizure medication monitoring',
  },
  {
  ...
  { name: 'Iron Studies Panel', category: 'Hematology', typicalUse: 'Iron deficiency vs overload' },
  {
    ...
    category: 'Hematology',
    typicalUse: 'Iron deficiency evaluation',
  },
...
async function main() {
  ...
  try {
    ...
    const labsToCreate = COMMON_LABS.filter((lab) => !existingNames.has(lab.name.toLowerCase()));

    console.log(
      `Found ${labsToCreate.length} labs to create (${COMMON_LABS.length - labsToCreate.length} already exist)\n`
    );
