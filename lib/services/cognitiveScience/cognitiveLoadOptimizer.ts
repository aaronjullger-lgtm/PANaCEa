...
export function calculateIntrinsicLoad(
  ...
  const rawLoad =
    (conceptComplexity / 10) * Math.log2(numInteractingElements + 1) * expertiseModifier;
 ...
 */
export function identifyExtraneousLoad(presentationFeatures: {
  ...
  if (presentationFeatures.hasRedundantText) {
    ...
    problems.push({
      ...
      description:
        'Remove on-screen text that duplicates narration. Use EITHER text OR audio, not both.',
  ...
  if (presentationFeatures.hasSplitAttention) {
    ...
    problems.push({
      ...
      description:
        'Integrate related text and diagrams spatially. Labels should be ON the diagram, not separate.',
  ...
  if (presentationFeatures.hasModalityMismatch) {
    ...
    problems.push({
      ...
      description:
        'Use visual channel for diagrams + auditory channel for explanations (dual-channel processing)',
  ...
  if (presentationFeatures.hasIrrelevantDetails) {
    ...
    problems.push({
      ...
      description:
        'Remove interesting but irrelevant details. "Cool facts" actually hurt learning.',
  ...
  if (presentationFeatures.hasWeaklyGuidedSearch) {
    ...
    problems.push({
      ...
      description:
        'Use signaling (arrows, highlights, color-coding) to direct attention to key elements.',
  ...
  if (presentationFeatures.hasTransientInfo) {
    ...
    problems.push({
      ...
      description:
        'Give learners control over pace. Allow pausing and replaying of transient info.',
      expectedReduction: 15,
      applicability: 'high',
 ...
 */
export function generateLoadBasedRecommendations(loadProfile: CognitiveLoadProfile): {
