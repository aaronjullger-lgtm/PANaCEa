...
export const buttonVariantStyles: Record<ButtonVariant, string> = {
  /* Primary: Semantic accent (light and dark) for main page CTAs */
  primary:
    'bg-[var(--color-accent)] text-white shadow-md border border-[var(--color-accent)] hover:opacity-90 dark:bg-[var(--color-accent)] dark:text-white dark:border-[var(--color-accent-hover)] dark:hover:brightness-110',
