...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for request/response shapes of recently hardened endpoints (admin readiness/media, analytics, branches, drills, feedback, graph, library ingestion, medical APIs, push, custom sessions, second-chance reviews, SRS due, FSRS params, daily plan).
