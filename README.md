...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (OSCE Live engine, enhanced question generation, session reflection, encounter agent invoke, and related service changes).
