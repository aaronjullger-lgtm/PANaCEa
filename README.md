...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (validation-hardened feedback, push subscribe, SOAP analytics, second-chance review, SRS due queue, and other recently updated routes).
