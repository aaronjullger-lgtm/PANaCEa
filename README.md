...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently changed endpoints (`/api/srs/due`, `/api/analytics/soap-note`, `/api/push/subscribe`, `/api/reviews/second-chance`).
