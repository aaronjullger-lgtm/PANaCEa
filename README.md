...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently changed endpoints (validation-hardened analytics, drills, feedback, push, custom-session, second-chance review, SRS due queue).
