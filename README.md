...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (content library extract/ingest, OSCE cleanup, structured rationale rendering, and other recently changed routes).
