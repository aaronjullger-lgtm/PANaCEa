...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints, including study question fetch/session routes and the canonical drill review submission pipeline.
