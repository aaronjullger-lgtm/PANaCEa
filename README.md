...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently updated endpoints, including `/api/content/library` and `/api/questions/attempt`.
