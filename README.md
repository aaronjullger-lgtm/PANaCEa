...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (agent invoke/stream/protocol/MCP, admin, OSCE, and other recently updated routes).
