...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently hardened endpoints (SOAP analytics, lab cases, feedback, push subscribe, custom session, second-chance review, SRS due queue).
