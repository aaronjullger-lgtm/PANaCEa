...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (SRS due queue, push subscriptions, SOAP analytics, second-chance review, admin/OSCE, and other recently changed routes).
