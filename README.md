...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (health, Gemini, content library, questions, user stats/goals/session, diagnostic puzzle, OSCE grading, admin enrichment).
