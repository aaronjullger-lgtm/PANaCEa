...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (agent runners, health, Gemini, content library, questions, goals/session, diagnostic puzzle, OSCE grading, admin enrichment).
