...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently updated endpoints (daily diagnostic puzzle, Medical Wordle, and other maintained routes).
