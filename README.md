...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (`/api/sync`, author submissions, admin blueprint/health reporting, cron analytics jobs, question context, and `/api/users/me/*` readiness/plan/outcome routes).
