...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently updated endpoints (`/api/sync`, `/api/user/preferences`, `/api/user/stats`, `/api/conditions/:conditionId/pearls`, `/api/osce/complete`, `/api/osce/analysis/grade`).
