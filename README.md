...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (SOAP analytics, push subscriptions, second-chance review, and other recently changed routes).
