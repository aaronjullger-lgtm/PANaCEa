...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (SOAP analytics, push subscriptions, second-chance review, admin, OSCE, health, Gemini, content library, questions, goals/session, diagnostic puzzle).
