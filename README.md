...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (agents runner + Agent Protocol runs/threads, admin, OSCE, and other recently updated routes).
