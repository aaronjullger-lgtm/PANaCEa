...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (admin, OSCE, push subscribe, SOAP analytics, second-chance review, SRS due, and related validation-hardened mutation schemas).
