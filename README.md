...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently changed endpoints (analytics, drills, FSRS params, SRS due, graph, push, feedback, branches, admin media, custom sessions).
