...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (question fetch/serving, admin deep-generation preview, shared Vertex AI routing).
