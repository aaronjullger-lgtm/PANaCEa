...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (SRS due queue, feedback submission, push subscriptions, SOAP analytics, second-chance reviews, and other recently hardened routes).
