...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for request/response shapes of recently hardened routes (admin readiness, analytics, branches, drills, feedback, graph, library ingestion, push, custom sessions, second-chance reviews, SRS due, FSRS params, daily plan).
