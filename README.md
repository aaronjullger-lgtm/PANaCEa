...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (SRS due queue, custom study sessions, lab-case drills, feedback submission, push subscriptions, second-chance reviews, SOAP note analytics).
