...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (SOAP analytics, push subscribe, second-chance review, SRS due queue, admin, OSCE).
