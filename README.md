...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently changed endpoints (SOAP analytics, push subscriptions, second-chance review, SRS due queue).
