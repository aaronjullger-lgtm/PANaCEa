...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (diagnostic puzzle, Medical Wordle, and other recently changed routes).
