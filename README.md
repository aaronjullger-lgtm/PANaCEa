...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (push subscribe, SOAP analytics, second-chance review, SRS due queue, admin, OSCE, and other documented routes).
