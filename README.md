...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of recently changed endpoints, including mapping-enrichment routes (`/api/mapping-enrichment/gaps`, `/api/mapping-enrichment/suggest`, `/api/mapping-enrichment/suggestions`).
...
- [API Overview](docs/api/API_OVERVIEW.md) - Endpoint contracts (including mapping-enrichment routes)
