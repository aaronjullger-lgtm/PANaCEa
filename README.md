...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (Learner Agent, admin, OSCE, and other recently updated routes).
...
- [API Overview](docs/api/API_OVERVIEW.md) - Endpoint contracts (Learner Agent, admin, OSCE)
