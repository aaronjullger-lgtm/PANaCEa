...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (staging lake, admin staging review, AI Gateway shared helpers, plus previously documented admin/OSCE routes).
