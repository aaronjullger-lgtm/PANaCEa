...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for the latest contracts for active drill/attempt flows, including `/api/drills/submit-review`, `/api/drills/submit-reviews`, and `/api/questions/attempt`.
