...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for request/response shapes of recently changed endpoints (feedback submit, push subscribe, SOAP analytics, second-chance review, SRS due, admin, OSCE).
