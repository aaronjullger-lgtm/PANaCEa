...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (validation-hardened analytics/push/reviews routes, admin, OSCE, and other documented surfaces).
