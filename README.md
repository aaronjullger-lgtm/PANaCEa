...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (admin, OSCE, analytics/soap-note, push subscribe, second-chance review, SRS due, health, Gemini, content library, questions, goals/session, diagnostic puzzle).
