...
- **Endpoint contracts:** See `docs/api/API_OVERVIEW.md` for current request/response shapes of actively maintained endpoints (including `/api/ai/learning/socratic` and `/api/osce/evaluate` via the unified AI Gateway).
