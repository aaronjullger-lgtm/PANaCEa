...
export const SPECIALTY_CAQ_PACKS: SpecialtyCAQPack[] = [
  {
    ...
    description: 'Advanced orthopedic cases: fractures, sports medicine, joint replacements, and surgical decision-making.',
    releaseDate: '2025-01-15',
  },
  {
    id: 'dermatology',
    name: 'Dermatology CAQ',
    description: 'Comprehensive derm: lesion identification, biopsy interpretation, procedural dermatology, and cosmetic procedures.',
    releaseDate: '2025-02-01',
  },
  {
    id: 'psychiatry',
    name: 'Psychiatry CAQ',
    description: 'Advanced psych: complex medication management, therapy modalities, crisis intervention, and psychopharmacology.',
    releaseDate: '2025-02-15',
  },
  {
    id: 'emergency_medicine',
    name: 'Emergency Medicine CAQ',
    description: 'ER mastery: trauma protocols, critical procedures, toxicology, and high-acuity decision-making.',
