...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  // Organ Character Collection Achievements
  {
    id: 'bone_collector',
    name: 'Bone Collector',
    description: 'Unlock all MSK variants (Skeleton comes alive!)',
    rarity: 'epic',
    category: 'special',
    displayOrder: 450,
    icon: 'skull',
    ...
    requirements: {
      type: 'special',
      value: 1,
      condition: 'collect_all_msk',
    },
  },
  {
    id: 'cardiac_collector',
    name: 'Cardiac Collector',
    description: 'Unlock all cardiovascular character variants',
    rarity: 'rare',
    category: 'special',
    displayOrder: 451,
    icon: 'heart',
    ...
    requirements: {
      type: 'special',
      value: 1,
      condition: 'collect_all_cv',
    },
  },
  {
    id: 'respiratory_ranger',
    name: 'Respiratory Ranger',
    description: 'Unlock all pulmonary character variants',
    rarity: 'rare',
    category: 'special',
    displayOrder: 452,
    icon: 'wind',
    ...
    requirements: {
      type: 'special',
      value: 1,
      condition: 'collect_all_pulm',
    },
  },
  {
    id: 'organ_master',
    name: 'Organ System Master',
    description: 'Unlock all base organ characters',
    rarity: 'epic',
    category: 'milestone',
    displayOrder: 453,
    icon: 'sparkles',
    ...
    requirements: {
      type: 'special',
      value: 1,
      condition: 'collect_all_base',
    },
  },
  {
    id: 'variant_virtuoso',
    name: 'Variant Virtuoso',
    description: 'Unlock 50 character variants',
    rarity: 'legendary',
    category: 'milestone',
    displayOrder: 454,
    icon: 'trophy',
    hidden: true,
    hiddenName: 'Locked Achievement',
    hiddenDescription: 'Unlock many character variants',
    requirements: {
      type: 'special',
      value: 50,
      condition: 'unlock_variants',
    },
  },
  {
    id: 'accessory_addict',
    name: 'Accessory Addict',
    description: 'Unlock 20 character accessories',
    rarity: 'epic',
    category: 'milestone',
    displayOrder: 455,
    icon: 'crown',
    ...
    requirements: {
      type: 'special',
      value: 20,
      condition: 'unlock_accessories',
    },
  },
  {
    id: 'perfect_collection',
    name: 'Perfect Collection',
    description: 'Unlock every character variant and accessory',
    rarity: 'legendary',
    category: 'milestone',
    displayOrder: 456,
    icon: 'star',
    hidden: true,
    hiddenName: 'Locked Achievement',
    hiddenDescription: 'Complete the entire collection',
    requirements: {
      type: 'special',
      value: 1,
      condition: 'complete_collection',
    },
  },
];
