...
export const GUIDELINE_REGISTRY: GuidelineMeta[] = [
  ...
  { name: "Atrial Fibrillation Management", organization: "AHA/ACC/HRS", category: "Treatment", year: 2023 },
  { name: "Hypertension Management (JNC 8)", organization: "JNC", category: "Treatment", year: 2014 },
  ...
  { name: "Colorectal Cancer Screening", organization: "USPSTF", category: "Screening", year: 2021 },
  ...
  { name: "Prostate Cancer Screening (PSA)", organization: "USPSTF", category: "Screening", year: 2018 },
  { name: "Abdominal Aortic Aneurysm Screening", organization: "USPSTF", category: "Screening", year: 2019 },
  ...
  { name: "Immunization Schedule (Adult)", organization: "CDC", category: "Prevention", year: 2024 },
  { name: "Immunization Schedule (Pediatric)", organization: "CDC", category: "Prevention", year: 2024 },
  ...
  { name: "Sepsis Management (Surviving Sepsis)", organization: "Surviving Sepsis Campaign", category: "Treatment", year: 2021 },
  ...
  { name: "Community-Acquired Pneumonia", organization: "ATS/IDSA", category: "Treatment", year: 2019 },
  
  // Endocrine
  { name: "Diabetes Management (ADA)", organization: "ADA", category: "Treatment", year: 2024 },
  { name: "Thyroid Dysfunction Management", organization: "ATA", category: "Treatment", year: 2016 },
  ...
  // Nephrology
  { name: "Chronic Kidney Disease Management", organization: "KDIGO", category: "Treatment", year: 2024 },
  ...
  { name: "Dementia Screening and Management", organization: "AAN", category: "Treatment", year: 2018 },
  ...
  // Psychiatry
  { name: "Major Depressive Disorder Treatment", organization: "APA", category: "Treatment", year: 2010 },
  ...
  { name: "Anaphylaxis Management", organization: "ACAAI/AAAAI", category: "Treatment", year: 2020 },
  
  // Anticoagulation
  { name: "Anticoagulation for Atrial Fibrillation", organization: "AHA/ACC", category: "Treatment", year: 2023 },
  { name: "VTE Treatment and Prevention", organization: "ACCP", category: "Treatment", year: 2016 },
  { name: "Perioperative Anticoagulation", organization: "ACCP", category: "Treatment", year: 2012 },
];
