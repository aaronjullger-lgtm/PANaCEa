...
export const MEDICAL_TERMS: Record<string, MedicalTermDefinition> = {
  'anion gap': {
    term: 'Anion Gap',
    definition: 'Difference between measured cations and anions in serum, used to classify metabolic acidosis.',
    category: 'lab'
  },
  'tachyphylaxis': {
    term: 'Tachyphylaxis',
  ...
  'stemi': {
    term: 'STEMI',
    definition: 'ST-Elevation Myocardial Infarction; transmural MI requiring immediate reperfusion.',
    category: 'condition'
  },
  'nstemi': {
    term: 'NSTEMI',
...
export const TooltipProvider: React.FC<TooltipProviderProps> = ({ children }) => {
  ...
  const showTooltip = useCallback((term: string, x: number, y: number) => {
