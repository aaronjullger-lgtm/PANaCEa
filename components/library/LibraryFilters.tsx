    ...
    <div className="flex flex-col md:flex-row gap-3">
      ...
      <div className="relative flex-1">
        ...
        <select
          ...
          className="w-full pl-10 pr-4 py-2 bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        >
      ...
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      </div>
