      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="fixed bottom-20 right-4 w-96 max-h-[80vh] bg-white bg-[var(--color-text-muted)] rounded-xl shadow-2xl border border-[var(--color-text-muted)] border-[var(--color-text-muted)] overflow-hidden z-50"
          >
            {/* Header */}
            <div className="p-4 border-b border-[var(--color-text-muted)] border-[var(--color-text-muted)] bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800">
            ...
            {/* Tabs */}
            <div className="flex border-b border-[var(--color-text-muted)] border-[var(--color-text-muted)]">
              <button
            ...
            <div className="overflow-y-auto max-h-[60vh]">
                    ...
                    <div className="space-y-3">
                      {issues.map((issue) => (
                        <motion.div
                          ...
                          className="p-3 rounded-lg border border-[var(--color-text-muted)] border-[var(--color-text-muted)] bg-[var(--color-text-muted)] bg-[color-mix(in_srgb,var(--color-text-muted)_50%,transparent)]"
                        >
              ...
              {activeTab === 'patterns' && (
                <div className="p-4 space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 rounded-lg border border-[var(--color-text-muted)] border-[var(--color-text-muted)]">
                      ...
                      <div className="text-sm text-[var(--color-text-muted)] text-[var(--color-text-muted)] space-y-1">
                        <code className="block bg-[var(--color-text-muted)] bg-[var(--color-text-muted)] p-1 rounded">
                          p-6 space-y-4
                        </code>
            ...
            {/* Footer */}
            <div className="p-3 border-t border-[var(--color-text-muted)] border-[var(--color-text-muted)] bg-[var(--color-text-muted)] bg-[color-mix(in_srgb,var(--color-text-muted)_50%,transparent)]">
