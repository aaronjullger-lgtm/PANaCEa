      ...
      >
        <motion.button
          ...
          className={`w-full flex items-center justify-between p-3 rounded-lg border transition-colors ${
            isEnabled
              ...
              : 'bg-white dark:bg-data-neutral border-data-neutral dark:border-data-neutral text-data-neutral dark:text-data-neutral'
          }`}
        >
        ...
        {isHovered && preview && (
          <div
            ...
            aria-hidden
          >
            <div className="rounded-lg border border-data-neutral dark:border-data-neutral bg-white dark:bg-data-neutral shadow-lg overflow-hidden">
