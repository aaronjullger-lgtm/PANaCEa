    ...
    <div className="bg-[var(--color-bg-secondary)] rounded-xl p-4">
      ...
      <label className="flex items-center justify-between p-3 bg-[var(--color-bg-primary)] rounded-lg hover:bg-[var(--color-border)] transition-colors cursor-pointer mb-3">
        ...
        <input
          ...
          className="w-5 h-5 rounded border-[var(--color-border)] text-[var(--color-data-neutral)] focus:ring-[var(--color-data-neutral)]"
        />
      </label>
        ...
        <div className="space-y-2 pl-2 border-l-2 border-[var(--color-data-neutral)]/20 dark:border-[var(--color-data-neutral)]/40">
          ...
          <label className="flex items-center justify-between p-2 rounded-lg hover:bg-[var(--color-bg-primary)] transition-colors cursor-pointer">
            ...
            <input
              ...
              className="w-4 h-4 rounded border-[var(--color-border)] text-[var(--color-data-neutral)] focus:ring-[var(--color-data-neutral)]"
            />
          </label>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center justify-between p-3 bg-[var(--color-bg-primary)] rounded-lg hover:bg-[var(--color-border)] transition-colors cursor-pointer">
                      ...
                      <input
                        ...
                        className="ml-3 w-5 h-5 rounded border-[var(--color-border)] text-[var(--color-accent)] focus:ring-[var(--color-accent)]"
                      />
                    </label>
