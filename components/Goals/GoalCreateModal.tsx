          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 focus:border-[var(--color-accent)] focus:ring-[var(--color-accent)]"
