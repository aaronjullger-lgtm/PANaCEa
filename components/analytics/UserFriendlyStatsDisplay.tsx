  ...
  if (error) {
    ...
    return (
      <div className="space-y-6 relative">
        <UserStatsOverviewSkeleton withShimmer={false} />
        <div
          className="absolute inset-0 flex items-start justify-center pt-8 bg-[var(--color-bg-primary)]/80 backdrop-blur-sm rounded-xl"
          role="alert"
          aria-live="assertive"
        >
