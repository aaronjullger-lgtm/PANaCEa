...
export default function WeaknessCheatsheetExporter({
  ...
  return (
    <div className="rounded-xl p-4 bg-[var(--color-data-neutral)] dark:bg-[var(--color-data-neutral)] border border-[var(--color-data-neutral)] dark:border-[var(--color-data-neutral)]">
      <div className="flex items-center gap-2 mb-3">
        <FileText className="w-5 h-5 text-[var(--color-accent)]" />
        <h3 className="font-medium text-[var(--color-data-neutral)] dark:text-[var(--color-data-neutral)]">Yield Optimization</h3>
      </div>

      <p className="text-xs mb-4 text-[var(--color-data-neutral)] dark:text-[var(--color-data-neutral)]">
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium mb-2 text-[var(--color-data-neutral)] dark:text-[var(--color-data-neutral)]">
          Time Period
        </label>
      ...
      {summary.totalWeaknesses > 0 ? (
        ...
        <div className="p-3 rounded-lg mb-4 text-center bg-[var(--color-data-neutral)] dark:bg-[var(--color-success)]/10 border border-[var(--color-data-neutral)] dark:border-[var(--color-success)]/30">
