    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            {/* Outer glow ring - suppressed under reduced-motion to avoid vestibular triggers */}
            ...
            >
              {/* Shine effect - suppressed under reduced-motion */}
              {!prefersReducedMotion && (
                <motion.div
                  initial={{ x: '-100%' }}
                  animate={{ x: '200%' }}
              ...
              <div className="relative text-center">
                ...
                >
                  ...
                  >
                    ...
                    {/* Outer pulse ring - suppressed under reduced-motion */}
                    {!prefersReducedMotion && (
                      <motion.div
              ...
              {/* Decorative particles - suppressed under reduced-motion */}
              {!prefersReducedMotion &&
                [...Array(8)].map((_, i) => (
                  <motion.div
                    key={i}
