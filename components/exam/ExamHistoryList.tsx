      ...
      {showTrends && (
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50">
            ...
            <p className={`text-2xl font-bold ${stats.passRate >= 70 ? "text-emerald-600" : "text-amber-600"}`}>
              {stats.passRate}%
            </p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 relative">
            ...
            {trend && (
              <div className={`absolute top-2 right-2 flex items-center gap-0.5 text-xs ${
      ...
      <div className="space-y-3">
        {displayAttempts.map((attempt, index) => (
          ...
          >
            ...
            {attempt.status === "completed" && attempt.systemScores && Object.keys(attempt.systemScores).length > 0 && (
