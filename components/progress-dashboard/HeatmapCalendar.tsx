...
const COLOR_SCALES = {
  attempts: [
    'bg-data-neutral border border-data-neutral', // 0 - empty
    'bg-data-neutral', // 1-5
    'bg-data-neutral', // 6-10
    'bg-data-neutral', // 11-20
    'bg-[var(--color-bg-tertiary)]', // 21+
  ],
  accuracy: [
    'bg-data-neutral', // no data
    'bg-data-neutral', // <50%
    'bg-data-neutral', // 50-69%
    'bg-data-neutral', // 70-84%
  ...
  return (
    <div className="card-premium-glass card-noise-texture p-5 rounded-2xl w-full">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 text-xs text-data-neutral">
          <span>Less</span>
      ...
      <div className="flex mb-1 ml-8 relative w-[calc(100%-2rem)]">
        {monthLabels.map((label, idx) => {
          ...
          return (
            <div
              key={idx}
              className="absolute text-xs text-data-neutral font-medium"
              style={{
                left: `${left}%`,
                width: `${width}%`,
              }}
      ...
      {/* Summary stats */}
      <div className="mt-4 pt-3 border-t border-data-neutral/60 grid grid-cols-3 gap-4">
        <div className="text-center">
          <div className="text-3xl font-light text-data-neutral">
