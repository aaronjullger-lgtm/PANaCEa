        ...
        {isHovered && preview && (
          ...
          >
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-secondary)] shadow-lg overflow-hidden">
              <div className="p-2.5 border-b border-data-neutral flex items-center gap-2 bg-data-neutral/80">
                <span className="text-data-neutral shrink-0">{widget.icon}</span>
                <span className="text-xs font-medium text-data-neutral truncate">
                  {widget.label}
                </span>
              </div>
              <div className="p-2 flex items-baseline gap-1">
                <span className="text-lg font-light text-data-neutral">…</span>
              </div>
              <div className="px-2.5 pb-2.5 pt-0">
                <p className="text-[11px] text-data-neutral leading-snug">
                  {preview.description}
                </p>
              </div>
            </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <LayoutDashboard className="w-5 h-5 text-data-neutral" />
            <h3 className="font-medium text-data-neutral">Dashboard Widgets</h3>
          </div>
          <button
            onClick={onResetToDefaults}
            className="text-xs text-data-neutral hover:text-data-neutral transition-colors"
          >
            Reset to defaults
          </button>
        </div>

        <p className="text-xs text-data-neutral">
      ...
      <div className="border border-data-neutral rounded-xl overflow-hidden">
        <button
          ...
          className="w-full flex items-center justify-between gap-3 p-4 text-left bg-data-neutral/50 hover:bg-data-neutral transition-colors"
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-medium text-data-neutral">Deep Insight Metrics</h3>
          </div>
          {advancedExpanded ? (
        ...
        <AnimatePresence initial={false}>
          {advancedExpanded && (
            ...
            >
              <div className="p-4 pt-0 space-y-2 border-t border-data-neutral">
