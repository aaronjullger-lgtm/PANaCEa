...
import { AlertCircle, Lightbulb, Target, Stethoscope, UserCheck, Hospital, ShieldCheck, Pill } from 'lucide-react';
            ...
            <>
              ...
              <div className="flex items-center gap-2 text-xs text-slate-400 dark:text-slate-500">
                {ageDemographics.length > 0 && (
                  <span>{ageDemographics.join(' • ')}</span>
                )}
                {ageDemographics.length > 0 && content.gender_bias && <span>•</span>}
                {content.gender_bias && (
                  <span>{content.gender_bias}</span>
                )}
              </div>
            </>
          )}
            ...
            {content.patient_education && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h5 className="font-semibold text-indigo-900 dark:text-indigo-100">Patient Education</h5>
                </div>
            ...
            {content.disposition && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h5 className="font-semibold text-indigo-900 dark:text-indigo-100">Disposition/Referral</h5>
                </div>
                <div className="text-indigo-800 dark:text-indigo-200 ml-6">
            ...
            {content.prevention && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h5 className="font-semibold text-indigo-900 dark:text-indigo-100">Prevention/Screening</h5>
                </div>
                <div className="text-indigo-800 dark:text-indigo-200 ml-6">
