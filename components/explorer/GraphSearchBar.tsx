    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 border border-[var(--color-border)] rounded-lg bg-[var(--color-bg-secondary)] text-[var(--color-text-primary)] placeholder-text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] focus:border-transparent"
