...
import { FolderTree, X, Heart, Zap, Droplets, Wind, Shield, AlertTriangle, Brain, Activity, ArrowRight, BarChart3 } from 'lucide-react';
...
const SUBCATEGORY_OPTIONS = [
  { id: 'infections', name: 'Infectious Diseases', icon: Shield, color: 'green', description: 'Bacterial, viral, fungal, parasitic' },
  { id: 'autoimmune', name: 'Autoimmune', icon: AlertTriangle, color: 'amber', description: 'Rheumatoid, lupus, vasculitis' },
  { id: 'neoplastic', name: 'Neoplastic', icon: Activity, color: 'red', description: 'Cancers and tumors' },
  { id: 'cardiovascular', name: 'Cardiovascular', icon: Heart, color: 'rose', description: 'Arrhythmias, CHF, MI, angina' },
  { id: 'pulmonary', name: 'Pulmonary', icon: Wind, color: 'blue', description: 'Asthma, COPD, pneumonia, ILD' },
  { id: 'neurological', name: 'Neurological', icon: Brain, color: 'purple', description: 'Stroke, seizures, dementia, MS' },
  { id: 'endocrine', name: 'Endocrine', icon: Zap, color: 'indigo', description: 'Diabetes, thyroid, adrenal' },
  { id: 'gastrointestinal', name: 'Gastrointestinal', icon: Droplets, color: 'amber', description: 'IBD, hepatitis, cirrhosis' },
  { id: 'metabolic', name: 'Metabolic', icon: Activity, color: 'teal', description: 'Electrolytes, acid-base, nutrition' },
];
        ...
        {categoryBreakdown.length > 0 && (
          <div className="mt-6 bg-[var(--color-bg-secondary)] border border-[var(--color-border)] rounded-xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-semibold text-[var(--color-text-primary)]">Category Progress</h3>
            </div>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-lg bg-${subcategory.color}-100 dark:bg-${subcategory.color}-900/20`}>
                    <Icon className={`w-6 h-6 text-${subcategory.color}-600 dark:text-${subcategory.color}-400`} />
                  </div>
