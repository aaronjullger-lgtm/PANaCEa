...
import type { OsceStats, ConditionStats } from '@/hooks/useEncounterReducer';
...
export interface EncounterLandingViewProps {
  ...
  handleStartEncounter: (filters?: { targetSystems?: string[] } | null) => void;
...
const EncounterLandingView: React.FC<EncounterLandingViewProps> = ({
  onExit,
  osceStats,
  conditionStats,
  dueConditions,
