        ...
        >
          ...
          {onTeachMe && conditionSlug && (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-white rounded-lg transition-colors text-sm font-medium"
            >
