          ...
          {view === 'pilot' && (
            ...
            >
              ...
              <div className="card-cinematic p-5">
                ...
                {dashboardAnalytics?.heatmap.length ? (
                  <React.Suspense fallback={<div className="h-[180px] animate-pulse bg-[var(--color-bg-tertiary)] rounded-lg" />}>
                    <StudyHeatmap
                      data={dashboardAnalytics.heatmap}
                      height={180}
                    />
                  </React.Suspense>
                ) : (
                  <div className="flex h-[180px] items-center justify-center rounded-lg bg-[var(--color-bg-tertiary)] px-6 text-center text-sm text-[var(--color-text-muted)]">
                    Complete a few real study sessions and daily activity will appear here.
                  </div>
                )}
              </div>
