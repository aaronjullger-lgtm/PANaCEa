...
export function DashboardActionCard({
  ...
  return (
    ...
    >
      {/* Card Container - Deep Slate Gradient Background */}
      <div
            ...
            <div className="flex items-start gap-4">
              ...
              <div
                className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-xl 
                           ...
                           shadow-lg transition-all duration-300 group-hover:bg-white/10 group-hover:scale-110"
              >
                <Icon className="h-7 w-7 text-indigo-400 transition-colors duration-300 group-hover:text-indigo-300" />
              </div>
            ...
            <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-3">
              {stats.map((stat, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="rounded-lg bg-slate-950/50 border border-slate-800/50 p-3 backdrop-blur-sm"
                  >
                    <div className="flex items-center gap-2 mb-1">
                      {StatIcon && (
                        <StatIcon className="h-3.5 w-3.5 text-slate-500" />
                      )}
