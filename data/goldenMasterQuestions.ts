...
export const GOLDEN_MASTER_QUESTIONS: GoldenMasterQuestion[] = [
  // ========== CARDIO ==========
  {
    ...
    question: 'What is the mechanism of action of the first-line antiplatelet agent you would give this patient in addition to aspirin?',
    options: [
    ...
    rationale: {
      bottomLine: 'The diagnosis is acute STEMI (anterior), and the antiplatelet of choice in addition to aspirin is a P2Y12 inhibitor (e.g. clopidogrel); its mechanism is blocking the P2Y12 ADP receptor on platelets.',
      whyCorrect:
      ...
      whyIncorrectA: 'Aspirin irreversibly inhibits COX-1 and reduces thromboxane A2; the question asks for the agent given in addition to aspirin, so this is aspirin’s mechanism, not the add-on.',
      whyIncorrectC: 'GP IIb/IIIa inhibitors (e.g. abciximab) are used in specific PCI settings, not as the routine first-line oral add-on to aspirin in STEMI.',
      whyIncorrectD: 'Factor Xa inhibitors are anticoagulants (e.g. rivaroxaban), not the standard first-line antiplatelet add-on for STEMI.',
      clinicalPearl: 'In STEMI, DAPT = aspirin + P2Y12 inhibitor. P2Y12 inhibitors (clopidogrel, ticagrelor, prasugrel) work by blocking the P2Y12 ADP receptor on platelets.',
    ...
    tripleJump: {
      step1: 'Vignette → STEMI (anterior): crushing pain, ST-elevation V2–V4, relative hypotension.',
  ...
  // ========== PULM ==========
  {
    ...
    question: 'What is the most likely mechanism of resistance you must consider when choosing empiric therapy for this patient’s infection?',
    options: [
    ...
    rationale: {
      bottomLine: 'The diagnosis is COPD exacerbation with community-acquired pneumonia (CAP); empiric therapy must cover beta-lactamase-producing organisms (e.g. H. influenzae), so the mechanism of resistance to consider is beta-lactamase production.',
      whyCorrect:
      ...
      whyIncorrectB: 'Altered PBPs (e.g. PRSP) are relevant for S. pneumoniae resistance to penicillins, not the primary “must consider” mechanism in a COPD-focused empiric choice where beta-lactamase is central.',
      whyIncorrectC: 'Fluoroquinolone resistance is a consideration in some regions but the question is framed around empiric therapy choice where beta-lactamase is the classic mechanism to cover in COPD.',
      whyIncorrectD: 'VRSA is rare and not the routine resistance mechanism to consider for CAP/COPD empiric therapy.',
      clinicalPearl: 'In COPD exacerbation with CAP, cover beta-lactamase producers (H. influenzae, M. catarrhalis); use respiratory FQ or beta-lactam/BLI.',
      highYieldImageOrTable: 'N/A',
    },
    pearls: [
    ...
    tripleJump: {
      step1: 'Vignette → COPD exacerbation + CAP (consolidation, fever, crackles, air bronchograms).',
      step2: 'Empiric therapy must cover beta-lactamase-producing pathogens in COPD.',
      step3: 'Answer = resistance mechanism: beta-lactamase production hydrolyzing penicillins/cephalosporins.',
    },
  },
  ...
  // ========== GI ==========
  {
    ...
    question: 'What is the mechanism by which the first-line analgesic you would use for this condition provides pain relief?',
    options: [
    ...
    correctAnswerIndex: 0,
    rationale: {
      bottomLine: 'The diagnosis is acute pancreatitis (elevated lipase, epigastric pain radiating to back, gallstones); first-line analgesic is a non-opioid (e.g. NSAID), and its mechanism is inhibition of cyclooxygenase (COX), reducing prostaglandin-mediated pain and inflammation.',
      whyCorrect:
      ...
      whyIncorrectB: 'Opioids act at mu-opioid receptors but are second-line; the question asks for first-line analgesic mechanism.',
      whyIncorrectC: 'NMDA antagonism (e.g. ketamine) is not the first-line analgesic for pancreatitis.',
      whyIncorrectD: 'SNRIs are used for chronic pain/neuropathy, not as the first-line analgesic in acute pancreatitis.',
      clinicalPearl: 'Acute pancreatitis: first-line analgesic = NSAIDs (COX inhibition); use opioids as add-on if needed.',
      highYieldImageOrTable: 'N/A',
    },
    pearls: [
    ...
    tripleJump: {
      ...
      step3: 'Answer = mechanism of NSAID: inhibition of COX, reducing prostaglandin-mediated pain and inflammation.',
    },
  },
];
