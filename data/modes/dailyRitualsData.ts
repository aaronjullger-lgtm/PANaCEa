...
export const MEDICAL_WORDLE_WORDS = {
  drugs: [
    ...
    { word: 'WARFARIN', class: 'Anticoagulant', generation: 'Vitamin K antagonist', hint: 'Monitor INR' },
    ...
    { word: 'DIGOXIN', class: 'Cardiac Glycoside', generation: 'Classic', hint: 'Narrow therapeutic index' },
    { word: 'ATORVA', class: 'Statin', generation: 'HMG-CoA reductase inhibitor', hint: 'Lowers cholesterol' },
    { word: 'LOSART', class: 'ARB', generation: 'Angiotensin receptor blocker', hint: 'Treats hypertension' },
    { word: 'AMOXIC', class: 'Antibiotic', generation: 'Beta-lactam', hint: 'Penicillin derivative' },
    { word: 'CIPROF', class: 'Antibiotic', generation: 'Fluoroquinolone', hint: 'DNA gyrase inhibitor' },
    { word: 'CEFTRI', class: 'Antibiotic', generation: '3rd Gen Cephalosporin', hint: 'Broad spectrum' },
    { word: 'METFOR', class: 'Antidiabetic', generation: 'Biguanide', hint: 'First-line for T2DM' },
    { word: 'LISINOP', class: 'ACE Inhibitor', generation: 'First-line HTN', hint: 'Ends in -pril' },
    { word: 'AMLODIP', class: 'CCB', generation: 'Dihydropyridine', hint: 'Causes peripheral edema' },
    { word: 'PREDNISO', class: 'Steroid', generation: 'Glucocorticoid', hint: 'Anti-inflammatory' },
    { word: 'LEVOTHY', class: 'Thyroid Hormone', generation: 'T4 replacement', hint: 'For hypothyroidism' },
  ],
  conditions: [
...
export const MEDICAL_HISTORY_EVENTS: HistoricalMedicalEvent[] = [
  {
    ...
    description: 'Fleming noticed that a mold contaminating his bacterial cultures killed the bacteria. This serendipitous discovery revolutionized medicine and ushered in the antibiotic era.',
  ...
  },
  {
    ...
    description: 'Leonard Thompson, a 14-year-old diabetic, received the first injection of insulin. His condition improved dramatically, proving insulin as a life-saving treatment for diabetes.',
    relatedQuestions: [],
  },
  {
    ...
    description: 'The World Health Organization declared smallpox eradicated worldwide - the first and only human disease to be completely eliminated through vaccination.',
    relatedQuestions: [],
  },
  {
    id: 'dna-structure',
    ...
    description: "Watson and Crick published their paper describing DNA's double helix structure in Nature, revolutionizing biology and medicine.",
    relatedQuestions: [],
  },
  {
    ...
    description: 'Dr. Christiaan Barnard performed the first successful human heart transplant in Cape Town, South Africa, opening new possibilities for organ transplantation.',
    relatedQuestions: [],
  },
  {
    id: 'polio-vaccine',
    ...
    description: 'Jonas Salk announced the successful testing of his polio vaccine, leading to near-eradication of this devastating disease.',
    relatedQuestions: [],
  },
  {
    id: 'x-ray-discovery',
    ...
    description: 'Röntgen discovered X-rays accidentally while experimenting with cathode rays, revolutionizing diagnostic medicine.',
    relatedQuestions: [],
  },
  {
    id: 'ether-anesthesia',
    ...
    description: 'William Morton demonstrated ether anesthesia at Massachusetts General Hospital, making painless surgery possible.',
    relatedQuestions: [],
  },
];
...
export function canPurchaseStreakFreeze(userCoins: number, currentFreezes: number): boolean {
  return userCoins >= STREAK_FREEZE_CONFIG.costPerFreeze && 
