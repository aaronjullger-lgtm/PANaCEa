...
export const BUZZWORD_BANK: BuzzwordEntry[] = [
  ...
  { buzzword: 'Ankle-brachial index <0.9', condition: 'Peripheral Arterial Disease (PAD)', system: 'CV', subcategory: 'Vascular Disease', explanation: 'Indicates significant peripheral artery stenosis' },
  { buzzword: 'Machine-like murmur', condition: 'Patent Ductus Arteriosus (PDA)', system: 'CV', subcategory: 'Congenital Heart Disease', explanation: 'Continuous murmur heard best at left upper sternal border' },
  { buzzword: 'Differential cyanosis', condition: 'Patent Ductus Arteriosus (PDA)', system: 'CV', subcategory: 'Congenital Heart Disease', explanation: 'Lower extremity cyanosis with pink upper extremities' },
  { buzzword: 'Fixed split S2', condition: 'Atrial Septal Defect (ASD)', system: 'CV', subcategory: 'Congenital Heart Disease', explanation: 'Does not vary with respiration' },
  { buzzword: 'Osborn J waves', condition: 'Hypothermia', system: 'CV', subcategory: 'ECG', explanation: 'Positive deflection at QRS-ST junction' },
  { buzzword: 'Wide bizarre QRS', condition: 'Premature Ventricular Contraction (PVC)', system: 'CV', subcategory: 'ECG', explanation: 'Premature beat with wide QRS and no P wave' },
  { buzzword: 'Rib notching', condition: 'Coarctation of the Aorta', system: 'CV', subcategory: 'Congenital Heart Disease', explanation: 'Erosion of ribs by collateral vessels' },
  { buzzword: '3 sign', condition: 'Coarctation of the Aorta', system: 'CV', subcategory: 'Congenital Heart Disease', explanation: 'Indentation of aorta at coarctation site on CXR' },
  { buzzword: 'Widened mediastinum', condition: 'Aortic Dissection', system: 'CV', subcategory: 'Vascular Disease', explanation: 'Classic CXR finding' },
  { buzzword: 'Virchow triad', condition: 'Deep Venous Thrombosis (DVT)', system: 'CV', subcategory: 'Vascular Disease', explanation: 'Stasis, hypercoagulability, endothelial injury' },
  { buzzword: '6 Ps', condition: 'Acute Arterial Occlusion', system: 'CV', subcategory: 'Vascular Disease', explanation: 'Pain, pallor, pulselessness, paresthesia, paralysis, poikilothermia' },

  // ========================
  // PULMONARY (PULM)
  // ========================
  { buzzword: 'Barrel chest', condition: 'Chronic Obstructive Pulmonary Disease (COPD)', system: 'PULM', subcategory: 'Obstructive', explanation: 'Increased AP diameter due to hyperinflation' },
  ...
  { buzzword: 'Ghon complex', condition: 'Tuberculosis', system: 'PULM', subcategory: 'Infectious', explanation: 'Primary focus in mid-lung zone with hilar lymphadenopathy' },
  ...
  { buzzword: 'Air bronchograms', condition: 'Community-Acquired Pneumonia', system: 'PULM', subcategory: 'Infectious', explanation: 'Air-filled bronchi visible within consolidated lung' },
  ...
  { buzzword: 'Tram-tracking', condition: 'Bronchiectasis', system: 'PULM', subcategory: 'Obstructive', explanation: 'Thickened bronchial walls on CT' },
  { buzzword: 'Samter triad', condition: 'Aspirin Exacerbated Respiratory Disease (AERD)', system: 'PULM', subcategory: 'Obstructive', explanation: 'Asthma, nasal polyps, aspirin sensitivity' },
  { buzzword: 'Currant jelly sputum', condition: 'Klebsiella Pneumonia', system: 'PULM', subcategory: 'Infectious', explanation: 'Thick, bloody, mucoid sputum' },
  { buzzword: 'Rust-colored sputum', condition: 'Streptococcal Pneumonia', system: 'PULM', subcategory: 'Infectious', explanation: 'Classic sputum appearance' },
  { buzzword: 'Green sputum', condition: 'Pseudomonas Pneumonia', system: 'PULM', subcategory: 'Infectious', explanation: 'Verdin pigment' },
  { buzzword: 'Foul-smelling sputum', condition: 'Aspiration Pneumonia', system: 'PULM', subcategory: 'Infectious', explanation: 'Suggests anaerobic infection' },
  { buzzword: 'Sweat chloride > 60', condition: 'Cystic Fibrosis', system: 'PULM', subcategory: 'Obstructive', explanation: 'Diagnostic standard' },
  ...
  { buzzword: 'Reynolds pentad', condition: 'Cholangitis', system: 'GI', subcategory: 'Gallbladder', explanation: 'Charcot triad plus hypotension and AMS' },
  ...
  { buzzword: 'Bird beak appearance', condition: 'Achalasia', system: 'GI', subcategory: 'Esophagus', explanation: 'Tapering of distal esophagus on barium swallow' },
  { buzzword: 'String sign (Pylorus)', condition: 'Pyloric Stenosis', system: 'GI', subcategory: 'Stomach', explanation: 'Narrowed pyloric channel' },
  { buzzword: 'Olive-shaped mass', condition: 'Pyloric Stenosis', system: 'GI', subcategory: 'Stomach', explanation: 'Palpable epigastric mass' },
  { buzzword: 'Step-ladder air-fluid levels', condition: 'Small Bowel Obstruction', system: 'GI', subcategory: 'Small Bowel', explanation: 'Classic abdominal X-ray finding' },
  { buzzword: 'Painless jaundice', condition: 'Pancreatic Cancer', system: 'GI', subcategory: 'Pancreas', explanation: 'Classic presentation of head of pancreas tumor' },
  { buzzword: 'Rice water stool', condition: 'Vibrio (Cholera / Parahemolyticus)', system: 'GI', subcategory: 'Infectious', explanation: 'Watery diarrhea with flecks of mucus' },
  { buzzword: 'Pea soup diarrhea', condition: 'Typhoid Fever', system: 'GI', subcategory: 'Infectious', explanation: 'Classic stool description' },
  ...
  { buzzword: 'Kernig sign', condition: 'Bacterial Meningitis', system: 'NEURO', subcategory: 'Infectious', explanation: 'Pain with knee extension when hip flexed' },
  { buzzword: 'Brudzinski sign', condition: 'Bacterial Meningitis', system: 'NEURO', subcategory: 'Infectious', explanation: 'Hip flexion with neck flexion' },
  ...
  { buzzword: 'Saddle anesthesia', condition: 'Cauda Equina Syndrome', system: 'NEURO', subcategory: 'Spine', explanation: 'Loss of sensation in perineal area' },
  { buzzword: 'Shopping cart sign', condition: 'Spinal Stenosis', system: 'NEURO', subcategory: 'Spine', explanation: 'Relief with forward flexion' },
  ...
  { buzzword: 'Auspitz sign', condition: 'Plaque Psoriasis', system: 'DERM', subcategory: 'Papulosquamous', explanation: 'Pinpoint bleeding when scale removed' },
  { buzzword: 'Koebner phenomenon', condition: 'Plaque Psoriasis', system: 'DERM', subcategory: 'Papulosquamous', explanation: 'Lesions at sites of trauma' },
  ...
  { buzzword: 'Dewdrop on a rose petal', condition: 'Varicella (Chickenpox)', system: 'DERM', subcategory: 'Infectious – Viral', explanation: 'Vesicle on erythematous base' },
  { buzzword: 'Dermatomal distribution', condition: 'Herpes Zoster (Shingles)', system: 'DERM', subcategory: 'Infectious – Viral', explanation: 'Vesicles following nerve distribution' },
  ...
  // HEMATOLOGY (HEME)
  // ========================
  { buzzword: 'Auer rods', condition: 'Acute Myeloid Leukemia (AML)', system: 'HEME', subcategory: 'Leukemia', explanation: 'Pink needle-like inclusions in myeloblasts' },
  { buzzword: 'Smudge cells', condition: 'Chronic Lymphocytic Leukemia (CLL)', system: 'HEME', subcategory: 'Leukemia', explanation: 'Fragile lymphocytes destroyed on smear' },
  { buzzword: 'Philadelphia chromosome', condition: 'Chronic Myelogenous Leukemia (CML)', system: 'HEME', subcategory: 'Leukemia', explanation: 't(9;22) BCR-ABL fusion gene' },
  ...
  { buzzword: 'Target cells', condition: 'Beta Thalassemia', system: 'HEME', subcategory: 'Hemoglobinopathy', explanation: 'Bull\'s eye appearance on smear' },
  ...
  { buzzword: 'Tear drop cells', condition: 'Primary Myelofibrosis', system: 'HEME', subcategory: 'Myeloproliferative', explanation: 'Dacrocytes from marrow fibrosis' },
  { buzzword: 'Dry tap', condition: 'Primary Myelofibrosis', system: 'HEME', subcategory: 'Myeloproliferative', explanation: 'Unable to aspirate bone marrow' },

  // ========================
  // ENDOCRINE (ENDO)
  // ========================
  { buzzword: 'Exophthalmos', condition: 'Hyperthyroidism (Graves Disease)', system: 'ENDO', subcategory: 'Thyroid', explanation: 'Protrusion of eyes' },
  { buzzword: 'Pretibial myxedema', condition: 'Hyperthyroidism (Graves Disease)', system: 'ENDO', subcategory: 'Thyroid', explanation: 'Non-pitting edema on shins' },
  { buzzword: 'Thyroid bruit', condition: 'Hyperthyroidism (Graves Disease)', system: 'ENDO', subcategory: 'Thyroid', explanation: 'Vascular hum over hypervascular thyroid' },
  ...
  { buzzword: 'Hyperpigmentation', condition: 'Addison Disease (Primary Adrenal Insufficiency)', system: 'ENDO', subcategory: 'Adrenal', explanation: 'Bronze skin from elevated ACTH' },
  { buzzword: 'Salt craving', condition: 'Addison Disease (Primary Adrenal Insufficiency)', system: 'ENDO', subcategory: 'Adrenal', explanation: 'Due to mineralocorticoid deficiency' },
  { buzzword: 'Fruity breath', condition: 'Diabetic Ketoacidosis (DKA)', system: 'ENDO', subcategory: 'Diabetes', explanation: 'Acetone from ketone production' },
  { buzzword: 'Kussmaul breathing', condition: 'Diabetic Ketoacidosis (DKA)', system: 'ENDO', subcategory: 'Diabetes', explanation: 'Deep, rapid respirations for CO2 clearance' },
  ...
  { buzzword: 'Stones, bones, groans, moans', condition: 'Primary Hyperparathyroidism', system: 'ENDO', subcategory: 'Calcium/Parathyroid', explanation: 'Kidney stones, bone pain, constipation, psych symptoms' },
  ...
  { buzzword: 'Positively birefringent crystals', condition: 'Pseudogout (Calcium Pyrophosphate Deposition)', system: 'MSK', subcategory: 'Crystal Disease', explanation: 'Blue under parallel light (CPPD)' },
  { buzzword: 'Chondrocalcinosis', condition: 'Pseudogout (Calcium Pyrophosphate Deposition)', system: 'MSK', subcategory: 'Crystal Disease', explanation: 'Calcium deposits in cartilage on X-ray' },
  ...
  { buzzword: 'Scotty dog defect', condition: 'Spondylolysis', system: 'MSK', subcategory: 'Spine', explanation: 'Pars interarticularis defect on oblique X-ray' },
  { buzzword: 'Dinner fork deformity', condition: 'Colles Fracture', system: 'MSK', subcategory: 'Trauma', explanation: 'Dorsal displacement of distal radius' },
  { buzzword: 'Garden spade deformity', condition: 'Smith Fracture', system: 'MSK', subcategory: 'Trauma', explanation: 'Volar displacement of distal radius' },
  { buzzword: 'Fat pad sign', condition: 'Radial Head Fracture', system: 'MSK', subcategory: 'Trauma', explanation: 'Suggests occult fracture' },
  { buzzword: 'Heberden nodes', condition: 'Osteoarthritis', system: 'MSK', subcategory: 'Rheumatologic', explanation: 'DIP joint osteophytes' },
  { buzzword: 'Bouchard nodes', condition: 'Osteoarthritis', system: 'MSK', subcategory: 'Rheumatologic', explanation: 'PIP joint osteophytes' },
  { buzzword: 'Swan neck deformity', condition: 'Rheumatoid Arthritis', system: 'MSK', subcategory: 'Rheumatologic', explanation: 'DIP flexion, PIP hyperextension' },
  { buzzword: 'Boutonniere deformity', condition: 'Rheumatoid Arthritis', system: 'MSK', subcategory: 'Rheumatologic', explanation: 'DIP hyperextension, PIP flexion' },
  { buzzword: 'Can\'t see, can\'t pee, can\'t climb a tree', condition: 'Reactive Arthritis (Reiter Syndrome)', system: 'MSK', subcategory: 'Rheumatologic', explanation: 'Uveitis, urethritis, arthritis' },
  { buzzword: 'Lachman test', condition: 'Anterior Cruciate Ligament (ACL) Tear', system: 'MSK', subcategory: 'Knee', explanation: 'Most sensitive test for ACL tear' },
  { buzzword: 'McMurray test', condition: 'Medial Meniscus Tear', system: 'MSK', subcategory: 'Knee', explanation: 'Pain/click with rotation and extension' },
  { buzzword: 'Thompson test', condition: 'Achilles Tendon Rupture', system: 'MSK', subcategory: 'Ankle', explanation: 'Lack of plantarflexion with calf squeeze' },
  { buzzword: 'Empty can test', condition: 'Rotator Cuff Tear', system: 'MSK', subcategory: 'Shoulder', explanation: 'Tests supraspinatus function' },
  ...
  { buzzword: 'Owl eye inclusions', condition: 'Cytomegalovirus (CMV)', system: 'ID', subcategory: 'Viral', explanation: 'Intranuclear inclusions with halo' },
  { buzzword: 'Negri bodies', condition: 'Rabies', system: 'ID', subcategory: 'Viral', explanation: 'Eosinophilic inclusions in neurons' },
  { buzzword: 'Downey cells', condition: 'Mononucleosis (EBV)', system: 'ID', subcategory: 'Viral', explanation: 'Atypical lymphocytes' },
  { buzzword: 'Heterophile antibodies', condition: 'Mononucleosis (EBV)', system: 'ID', subcategory: 'Viral', explanation: 'Monospot positive' },
  ...
  { buzzword: 'Red blood cell casts', condition: 'Acute Glomerulonephritis', system: 'RENAL', subcategory: 'Glomerular', explanation: 'Indicates glomerular bleeding' },
  ...
  { buzzword: 'Flank pain with hematuria', condition: 'Nephrolithiasis (General Evaluation)', system: 'RENAL', subcategory: 'Stones', explanation: 'Classic presentation of kidney stones' },
  ...
  { buzzword: 'Linear IgG deposits', condition: 'Anti-GBM Disease (Goodpasture)', system: 'RENAL', subcategory: 'Glomerular', explanation: 'Smooth linear pattern on immunofluorescence' },
  ...
  { buzzword: 'La belle indifference', condition: 'Conversion Disorder (Functional Neurological Symptom Disorder)', system: 'PSYCH', subcategory: 'Somatic Symptom & Related Disorders', explanation: 'Inappropriate lack of concern about symptoms' },
