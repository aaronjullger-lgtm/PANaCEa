...
router.post('/extract',
    ...
    async (req: Request, res: Response) => {
        try {
            ...
            const { createClinicalPearl } = await import('../lib/services/clinicalPearlService');
...
router.get('/daily',
    async (req: Request, res: Response) => {
        try {
            ...
            const { getDailyPearl } = await import('../lib/services/clinicalPearlService');
...
router.get('/user/:userId',
    async (req: Request, res: Response) => {
        try {
            ...
            const { getUserPearls } = await import('../lib/services/clinicalPearlService');
...
router.get('/user/:userId/favorites',
    async (req: Request, res: Response) => {
        try {
            ...
            const { getUserFavoritePearls } = await import('../lib/services/clinicalPearlService');
            const { userId } = req.params;
...
router.post('/:pearlId/useful',
    ...
    async (req: Request, res: Response) => {
        try {
            ...
            const { markPearlUseful } = await import('../lib/services/clinicalPearlService');
...
router.post('/search',
    async (req: Request, res: Response) => {
        try {
            ...
            const { searchPearls } = await import('../lib/services/clinicalPearlService');
...
router.get('/stats',
    async (req: Request, res: Response) => {
        try {
            ...
            const { getPearlStats } = await import('../lib/services/clinicalPearlService');
